...
served as static files from `public/lila/sort/`. No build step, no
...
| Path | What it is |
|---|---|
| [`engine.css`](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/public/lila/sort/engine.css) | Shared styles — palm-leaf theme, light + dark, 2–8 group palettes |
| [`engine.js`](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/public/lila/sort/engine.js) | The engine — `SortExercise.mount(container, config)` |
| [`index.html`](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/public/lila/sort/index.html) | Catalogue landing page |
| [`genders/index.html`](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/public/lila/sort/genders/index.html) | Drill: 24 nouns sorted into masculine / feminine / neuter |
| [`generator/index.html`](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/public/lila/sort/generator/index.html) | In-browser authoring tool → live preview + export |

## URLs (once deployed)

- Catalogue — `/lila/sort/`
- Genders drill — `/lila/sort/genders/`
- Generator — `/lila/sort/generator/`

## Authoring a new drill by hand

Create `public/lila/sort/<slug>/index.html`:
...
Open the [generator](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/public/lila/sort/generator/index.html):
