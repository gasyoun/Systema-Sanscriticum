...
- [Vendor, скопированный между деревьями: битый $baseDir — artisan мёртв до dump-autoload](2026-09-24-vendor-copy-between-trees-poisons-autoload-basedir.md) — Копия vendor несёт чужой $baseDir: artisan красный («App\Console\Kernel does not exist»), phpunit зелёный; лечится dump-autoload на месте; не копировать vendor без него.
