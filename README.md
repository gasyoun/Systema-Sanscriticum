...
- [~] **★ Прана — углубление геймификации** — [x] таблица лидеров по `lifetime_prana`
  (#202, маскированные имена, ранги, своя позиция); [x] бейджи-достижения (#204,
  8 бейджей из существующих сигналов, `config/badges.php`). [ ] осталось: новые
  сферы заработка/трат праны (стрик-награды, спенд на перки/контент).
