...
полностью закрыты** (включая редактор лекций v2 и вебинары Zoom). Мобильная
адаптация кабинета — тоже закрыта (кабинет уже был адаптивным, доставлена
полировка). Следующий приоритет (**P3**) — реферальная награда денежным кредитом.
...
- [ ] **★ Реферальная награда → денежный кредит** — заменить фиксированные 100 праны
  на реальный кредит/скидку (решено; следующий приоритет).
