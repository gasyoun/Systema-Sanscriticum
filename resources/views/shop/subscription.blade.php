{{--
    ...
    Публичная страница живет только при features.recorded_subscription = true
    ...
    зачеркнутая цена сверху карточек. Рассрочки на запуске НЕТ (миссия H3916).

    Формулировки согласованы с ограничениями H2645 (никакого куратора/ДЗ,
    никаких обещаний пожизненного доступа): подписка дает доступ ПОКА активна.
--}}
...
<main class="max-w-5xl mx-auto px-4 py-10">
    ...
    <p class="text-lg text-slate-300 mb-8">
        ...
        Смотрите в своем темпе, без расписания и дедлайнов.
    </p>
        ...
        @foreach ($tariffs as $tariff)
            ...
            <div class="rounded-2xl border {{ $isPro ? 'border-[#38BDF8]' : 'border-slate-800' }} bg-slate-900/60 p-6 flex flex-col">
                ...
                <ul class="text-sm text-slate-300 space-y-2 mb-6 flex-1">
                    ...
                    <li>✔ Все пополнение архива (потоки входят через 6 мес.)</li>
                    @if ($isPro)
    ...
    <section class="mb-8">
        ...
        <div class="space-y-5 text-slate-300">
            ...
            <div>
                ...
                <p>Отдельных зачетов нет. Тем, кто уже покупал записи, — скидка 5% на первый год: она применяется в корзине автоматически.</p>
            </div>
            <div>
