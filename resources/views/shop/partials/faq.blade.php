{{-- «FAQ по курсу» — course->faqs (по sort_order), аккордеон. Скрыт при пустом. --}}
@php $faqs = ($course->faqs ?? collect())->where('is_visible', true)->values(); @endphp
@if($faqs->isNotEmpty())
<section class="mb-16 lg:mb-20" data-analytics="faq" x-data="{ open: null }">
