{{--
    Общесайтовая полоса отзывов на витрине каталога (H323, social proof):
    избранные (is_featured) видимые отзывы из библиотеки. Пусто — секция
    не выводится. Ожидает: $testimonials (Collection<Testimonial>).
--}}
@if($testimonials->isNotEmpty())
<section class="mt-16 lg:mt-20" data-analytics="featured-testimonials">
    <h2 class="text-3xl font-bold text-white mb-8 text-center">Что говорят ученики</h2>
