...
<div data-analytics="free-intro-banner"
     ...
     class="border-b border-[#E85C24]/25 bg-gradient-to-r from-[#1A2235] via-[#151b2a] to-[#1A2235]">
    <div class="container mx-auto px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div class="flex items-start sm:items-center gap-3 min-w-0">
            <span class="shrink-0 w-9 h-9 rounded-xl bg-[#E85C24]/15 border border-[#E85C24]/35 text-[#E85C24] flex items-center justify-center"
                  aria-hidden="true">
                <i class="fas fa-calendar-check text-sm"></i>
            </span>
            <div class="min-w-0">
                <p class="text-[11px] font-black uppercase tracking-widest text-[#E85C24]/90 mb-0.5">
        ...
        <a href="{{ $ctaUrl }}"
           ...
           class="shrink-0 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#E85C24] hover:bg-[#d64e1c] text-white text-sm font-bold transition-all hover:-translate-y-0.5 shadow-[0_0_20px_rgba(232,92,36,0.25)]">
