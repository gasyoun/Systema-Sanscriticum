...
@php
    ...
    $trust = [
        [
            ...
            'text' => 'Преподаем санскрит '.max(1, now()->year - $trustSinceYear).'+ лет — в традиции живых учителей.',
        ],
        ['icon' => 'fas fa-film', 'title' => 'Записи всех занятий', 'text' => 'Доступ к видеозаписям остается с вами навсегда.'],
