...
@section('content')
    <div class="container mx-auto px-4 max-w-3xl py-10 md:py-14">
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-6 mb-8 shadow-sm">
            <p class="text-gray-700 leading-relaxed">
                Автопроверка дешёвая и мгновенная — и она не видит, ПОЧЕМУ ученик ошибся. Мы сознательно держим человека в цикле проверки: это основа качества и нашей цены.
            </p>
        </div>
