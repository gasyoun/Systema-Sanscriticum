{{--
  ...
  H4118 (05-09-2026): runtime Play CDN удален — его хост (v3.4.17)
  отдает сломанный in-browser JIT, который не генерирует `hidden` / `sm:*` /
  `md:*` для кабинетной разметки → десктопная верстка на iPhone (ox=646 на всех
  ...
  так что утилиты гарантированно есть в билде еще до отдачи страницы.
