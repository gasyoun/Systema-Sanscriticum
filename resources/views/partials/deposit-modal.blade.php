            ...
            <form :action="action" method="POST" class="p-6 space-y-4">
                ...
                <div class="rounded-xl border border-[#38BDF8]/30 bg-[#38BDF8]/10 p-3.5">
                    ...
                    <p class="text-[13px] text-slate-300 leading-relaxed">
                        ...
                        смотрите вебинары и материалы, пока ждёте начала курса.
                    </p>
                </div>
                ...
                @guest
                    ...
                    <p class="text-[11px] text-slate-500 leading-relaxed">
                        После оплаты мы пришлём пароль на email — войдёте в личный кабинет и сможете смотреть открытые уроки.
                    </p>
                @endguest
