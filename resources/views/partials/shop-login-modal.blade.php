...
<div x-data="shopLoginModal()"
    ...
    <span class="text-red-500 font-bold">ВАЖНО!</span> Если Вы раньше покупали наши курсы — не регистрируйтесь самостоятельно, напишите куратору. Он создаст аккаунт вручную, и все ваши доступы сохранятся.
</p>
