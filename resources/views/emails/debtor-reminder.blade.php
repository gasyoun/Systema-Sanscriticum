                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="padding: 0 40px 32px; color: #9aa0a6; font-size: 12px; line-height: 1.5;">
                            {{-- Тексты стадий лестницы H1289 сами заканчиваются строкой «просто
                                 проигнорируйте…» (в мессенджерах футера нет) — не дублируем её в
                                 футере; для кастомных текстов без неё футер остаётся страховкой. --}}
                            Это письмо отправлено по вашему обучению в Обществе ревнителей санскрита.@unless (str_contains($bodyText, 'просто проигнорируйте')) Если оплата уже внесена — просто проигнорируйте его.@endunless
                        </td>
                    </tr>
