...
<head>
    <meta charset="utf-8">
    <title>Приглашение в преподавательскую панель</title>
</head>
<body style="font-family: 'Georgia', serif; background-color: #fcf9f2; color: #3e3a37; line-height: 1.6; margin: 0; padding: 40px 20px;">
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 40px 30px; border-top: 6px solid #d35400; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
        ...
        <div style="background-color: #fff8f0; border-left: 4px solid #d35400; padding: 20px; margin: 30px 0; border-radius: 0 4px 4px 0;">
            ...
            <p style="margin: 8px 0; font-size: 16px;"><strong>Адрес панели:</strong> <span style="color: #d35400;">{{ $panelUrl }}</span></p>
            ...
            @else
                <p style="margin: 8px 0; font-size: 15px; color: #7f8c8d;">Войдите тем паролем, который вы уже используете на сайте. Забыли его — воспользуйтесь ссылкой <a href="{{ route('password.request') }}" style="color: #d35400;">«Восстановить пароль»</a>.</p>
            @endif
        </div>
        ...
        <div style="text-align: center; margin-top: 40px; margin-bottom: 30px;">
            <a href="{{ $panelUrl }}" style="background-color: #d35400; color: #ffffff; padding: 14px 35px; text-decoration: none; border-radius: 30px; font-weight: bold; font-size: 15px; display: inline-block; text-transform: uppercase; letter-spacing: 1px;">Войти в панель</a>
        </div>
