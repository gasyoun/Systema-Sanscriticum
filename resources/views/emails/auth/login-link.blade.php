...
<head>
    <meta charset="utf-8">
    <title>Ссылка для входа в личный кабинет ОРС</title>
</head>
<body style="font-family: 'Georgia', serif; background-color: #fcf9f2; color: #3e3a37; line-height: 1.6; margin: 0; padding: 40px 20px;">
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 40px 30px; border-top: 6px solid #d35400; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
        ...
        <p style="font-size: 18px; text-align: center;">Мы открыли вам вход в <strong>личный кабинет Общества ревнителей санскрита</strong> без пароля — по ссылке ниже.</p>

        <div style="text-align: center; margin-top: 35px; margin-bottom: 30px;">
            <a href="{{ $loginUrl }}" style="background-color: #d35400; color: #ffffff; padding: 14px 35px; text-decoration: none; border-radius: 30px; font-weight: bold; font-size: 15px; display: inline-block; letter-spacing: 1px;">Войти в кабинет</a>
        </div>

        <div style="background-color: #fff8f0; border-left: 4px solid #d35400; padding: 16px 20px; margin: 30px 0; border-radius: 0 4px 4px 0;">
            <p style="margin: 0; font-size: 15px;">⏳ Ссылка одноразовая и действует <strong>24 часа</strong>. Если кнопка не работает, скопируйте адрес в браузер:</p>
            <p style="margin: 10px 0 0; font-size: 13px; word-break: break-all; color: #d35400;">{{ $loginUrl }}</p>
        </div>

        <p style="font-size: 16px;">Пароль вводить не нужно. Если ссылка уже не работает — ответьте на это письмо, и мы вышлем новую.</p>

        <p style="font-style: italic; color: #7f8c8d; font-size: 15px; text-align: center;">Если вы не просили помощи со входом — просто проигнорируйте это письмо, ваш пароль не изменится.</p>
