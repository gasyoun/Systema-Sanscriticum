...
Студент сообщил об оплате из-за рубежа. Требуется **ручная сверка в PayPal** — доступ откроется, когда вы переведёте платёж в статус «Оплачено» в админке.
...
- **Рублёвый номинал:** {{ number_format((float) $payment->amount, 0, '.', ' ') }} ₽
...
После сверки в PayPal переведите платёж в статус «Оплачено» (фильтр «Заявки PayPal на проверке» → кнопка «Подтвердить PayPal») — студент получит доступ автоматически.
@endcomponent
