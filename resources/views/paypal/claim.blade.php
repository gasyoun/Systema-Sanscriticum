                ...
                <div>
                    ...
                    <p class="mt-2 text-base text-gray-500">
                        @if($isSupplement)
                            ...
                            счет закроется автоматически. Полная оплата блока оформляется обычной
                            формой, не этой.
                        @else
        ...
        <div class="bg-white p-6 sm:p-7 rounded-3xl shadow-sm shadow-gray-100/60 border border-gray-100">
            ...
            <ol class="space-y-3 text-sm text-gray-600 leading-relaxed list-none">
                ...
                <li class="flex gap-3">
                    ...
                    <span>Сразу после отправки пришлем на email подтверждение — счет по доплате закроется автоматически.</span>
                </li>
                <li class="flex gap-3">
