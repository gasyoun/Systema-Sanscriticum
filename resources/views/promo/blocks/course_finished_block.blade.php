@php
    ...
    // Контент
    $title = $data['title'] ?? 'Курс завершен';
    $subtitle = $data['subtitle'] ?? 'Повторный набор не планируется. Все лекции доступны в записи — учитесь в своем темпе с пожизненным доступом.';
