    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-lg md:text-xl opacity-80 mb-10 leading-relaxed max-w-3xl mx-auto">
                {{ $data['description'] ?? 'Мы понимаем. Начинать новое всегда волнительно. Поэтому приглашаем вас на бесплатное пробное занятие — без обязательств и оплаты. Вы познакомитесь с преподавателем, попробуете свои силы и поймете, насколько это комфортно именно для вас. Если не зайдет — останетесь при своем, ничего не потеряв.' }}
            </p>
