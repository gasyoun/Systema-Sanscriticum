...
<div class="bg-white rounded-2xl border border-gray-100 p-4 md:p-5 mb-6" data-tz-card
    ...
    <div class="flex items-start justify-between gap-3">
        <div>
            ...
            <p class="text-gray-500 text-xs md:text-sm">
                ...
                @else
                    Ваше время совпадает с московским — все показывается как есть.
                @endif
            </p>
        </div>
    ...
    <div id="tz-settings" class="hidden mt-4 space-y-4">
        ...
        <p class="text-[11px] text-gray-400">
            Мы определили вашу зону автоматически по часам устройства и не показываем ее никому.
            Занятия всегда идут по московскому времени — местное рядом.
        </p>
    </div>
</div>

{{-- Silent device-TZ capture: один POST, если зона устройства не совпадает с сохраненной
