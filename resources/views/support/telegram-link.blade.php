...
<div class="card">
    ...
    @else
        ...
        <p>Укажите почту, на которую у вас аккаунт школы (или создайте новый — это бесплатно). После этого бот начнет отвечать в Telegram сам.</p>
        @if (session('support_linked'))
            <div style="background:#eef7ee;border-radius:8px;padding:.8rem 1rem;margin-bottom:1rem;">
                Связывание выполнено. Вернитесь в Telegram — задайте вопрос еще раз.
            </div>
        @endif
