        ...
        <div class="bg-gray-50 border border-gray-200 rounded-2xl p-6 mb-6">
            ...
            <ul class="list-disc pl-5 space-y-1 text-gray-700 leading-relaxed">
                ...
                <li>доступ к записи — момент отправки вам доступа (ссылки, пароля)
                    к материалам;</li>
                <li>если на момент оплаты услуга еще не началась (купили заранее) —
                    сроки из списка «100% вернется» (за 1 день для «живого» участия,
                    7 дней для записей) считаются с момента ее начала, а не оплаты
