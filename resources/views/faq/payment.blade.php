...
@section('title', 'Оплата курса — способы, рассрочка, если платеж не прошел — FAQ')
@section('meta_description', 'Как оплатить курс ОРС: способы оплаты, рассрочка, что делать, если платеж отклонен или обещание оплаты просрочено, куда писать куратору.')
...
<div class="container mx-auto px-4 max-w-3xl py-10 md:py-14 font-nunito">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Способы оплаты, рассрочка, если платеж не прошел</p>
        </div>
    </div>
    ...
    <p class="text-gray-600 leading-relaxed mb-8">
        ...
        Если что-то не сходится или платеж не проходит — ниже частые ситуации и куда писать.
    </p>
    ...
    <h2 class="text-xl font-bold text-gray-900 mb-3">Платеж отклонен или отменен</h2>
    <p class="text-gray-700 leading-relaxed mb-2">
        Банк иногда блокирует онлайн-платеж без видимой причины (лимит, антифрод, устаревшие данные карты).
    ...
    <ol class="list-decimal list-inside space-y-2 text-gray-700 leading-relaxed mb-8">
        ...
        <li>Попробуйте оплатить еще раз — часто со второго раза проходит</li>
        <li>Не проходит снова — попробуйте другую карту или рассрочку</li>
        <li>Не получается — напишите куратору, разберемся вместе</li>
    </ol>

    <h2 class="text-xl font-bold text-gray-900 mb-3">Просрочена договоренность об оплате</h2>
    <p class="text-gray-700 leading-relaxed mb-8">
        Если был согласован график (обещание/рассрочка) и срок прошел — это тоже не блокирует уже оплаченные
        уроки и живые занятия группы. Зайдите в «Оплата и доступ» и внесите ближайший платеж по графику,
