    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <p class="mt-2 text-base text-gray-500">
                ...
                зачтем платеж. Перевод может уйти на счет самого преподавателя или через
                посредника (например, Эдгара Лейтана) — в анкете важно указать, за курс
                какого преподавателя оплата. Без этой заявки оплата останется незачтенной:
        ...
        <div class="bg-white p-6 sm:p-7 rounded-3xl shadow-sm shadow-gray-100/60 border border-gray-100 mb-6">
            ...
            <p class="text-sm text-gray-600 leading-relaxed">
                ...
                на счет преподавателя или через посредника (например, Лейтана).
