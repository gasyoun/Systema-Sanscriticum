...
<div class="max-w-3xl mx-auto px-4 sm:px-6 py-10">
    {{-- H2869: витринный layout темный (#0A0D14) — gray-900/gray-500 на нем
    ...
    <p class="text-sm text-slate-300 mb-6">Ограниченный набор частотных единиц. Полный тренажер — в кабинете после оплаты курса.</p>
