@php
    // $rows — массив строк предпросмотра из CoursesRelationManager::buildBlockPreview().
...
<div class="space-y-3 text-sm">
    ...
    <p class="text-xs text-gray-400">
        Зеленым — что проставится. Серым — уже заполнено вручную, оставляем как есть.
        Нужно поправить число — закройте окно и используйте кнопку на конкретной строке.
    </p>
</div>
