<x-filament-panels::page>
    ...
    <div class="rounded-xl bg-gray-50 p-4 ring-1 ring-gray-950/5 dark:bg-white/5 dark:ring-white/10">
        ...
        <div class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            Это отправные ориентиры для ручного ввода, а не готовый сценарий: крупная трата — forward-looking, ее выручку/расходы задает человек.
        </div>
    </div>
    ...
    <div class="text-xs text-gray-500 dark:text-gray-400 space-y-1">
        <div><b>NPV</b> — чистая приведенная стоимость: сумма дисконтированных потоков за горизонт минус капзатраты. NPV &gt; 0 ⇔ IRR выше ставки дисконтирования.</div>
        ...
        <div>Модель forward-looking: доп. выручка растет на «рост, % в год» (ramp-up), расходы плоские. Ставка/горизонт/порог — config/investment.php (меняются через .env). Денег не двигает.</div>
