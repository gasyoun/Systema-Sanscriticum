<x-filament-panels::page>
    ...
    <div class="rounded-xl bg-gray-50 p-3 text-sm ring-1 ring-gray-950/5 dark:bg-white/5 dark:ring-white/10">
        <p class="text-gray-700 dark:text-gray-200">
            ...
            Сегмент и исключения (Покинул/Исключен/Льготник/Выпускник) — те же, что у «Должников».
        </p>
        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
            ...
            решает сам, теплым тоном и без давления (срочность и «все берут» отталкивают).
        </p>
    </div>
