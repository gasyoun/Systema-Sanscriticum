<x-filament-panels::page>
    <div class="rounded-xl bg-gray-50 p-4 text-sm ring-1 ring-gray-950/5 dark:bg-white/5 dark:ring-white/10">
        ...
        <ol class="mt-2 list-decimal space-y-1 ps-5 text-gray-700 dark:text-gray-300">
            <li>
                В список кандидатов человек попадает, когда сходится все сразу:
            ...
            <li>
                Сразу после кика нажмите здесь <b>«Записать исключение»</b> — строка попадет в реестр
            ...
            <li>
                ...
                из которого студента выгнали. Кнопка «Возвращен в чат» до этого не появится.
            </li>
        </ol>
