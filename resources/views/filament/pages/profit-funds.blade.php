<x-filament-panels::page>
    ...
    <div class="text-xs text-gray-500 dark:text-gray-400 space-y-1">
        ...
        <div><b>Накопленный фонд</b> — управленческий earmark (сумма месячных отчислений за окно), не отдельный банковский счёт: у LMS нет банковского леджера.</div>
        <div><b>Обеспеченность резерва</b> = накопленный чистый денежный поток ДДС ÷ накопленный резерв. Ниже 100% — резерв не полностью подкреплён реальными деньгами.</div>
