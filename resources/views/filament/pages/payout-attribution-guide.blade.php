...
<x-filament-panels::page>
    ...
    <div class="rounded-xl bg-primary-50 p-4 text-sm ring-1 ring-primary-500/20 dark:bg-primary-500/10">
        ...
        <p class="mt-1 text-primary-900/80 dark:text-primary-200/80">
            ...
            он только помечает, чем платеж был.
        </p>
    </div>
    ...
    <section class="space-y-2">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-300">
            ...
            обычным платежом с тарифом <b>«Расход»</b>, причем на служебного пользователя.
    ...
    <section class="space-y-3">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Что сейчас ждет вашего решения</h2>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <thead class="bg-gray-50/60 text-xs text-gray-500 dark:bg-white/5 dark:text-gray-400">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left font-semibold">На кого заведен</th>
    ...
    <section class="space-y-3">
        ...
        <ol class="list-decimal space-y-2 pl-5 text-sm text-gray-600 dark:text-gray-300">
            ...
            <li>
                <b>Не нашли платеж или сомневаетесь — оставьте строку как есть.</b>
                Неразмеченная строка честнее размеченной наугад: от этой разметки зависит
                сумма, которую мы назовем преподавателю.
            </li>
        </ol>
        ...
        <div class="rounded-xl bg-gray-50 p-4 text-sm text-gray-600 ring-1 ring-gray-950/5 dark:bg-white/5 dark:text-gray-300 dark:ring-white/10">
            <b>Ошиблись?</b> У решенной строки появляется кнопка «Вернуть в очередь» —
    ...
    <section class="space-y-3">
        ...
        <ul class="list-disc space-y-2 pl-5 text-sm text-gray-600 dark:text-gray-300">
            <li>
                <b>Не искать в очереди платежи, заведенные прямо на преподавателя.</b>
                Они уже посчитаны и в список не попадают — подтверждать их еще раз не нужно
                и не получится.
            </li>
            <li>
    ...
    <section class="space-y-2">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-300">
            ...
            слово «предварительно» исчезнет само, и остаток станет подтвержденной цифрой.
