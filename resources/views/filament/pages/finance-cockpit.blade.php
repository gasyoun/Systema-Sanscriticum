<x-filament-panels::page>
    ...
    {{-- ОПиУ по методу начисления (accrual) — выручка признается по месяцам блоков --}}
    <x-filament::section>
        ...
        {{-- Отложенная выручка: оплачено, но еще не отработано — обязательство --}}
        ...
        <p class="mt-3 text-xs text-gray-400">
            Сумма признанной выручки за все время равна кассовой — метод начисления лишь перераспределяет ее между месяцами занятий. Расходная часть у обеих вкладок одинакова.
        </p>
    </x-filament::section>
