...
final class GrammarGasuns2026Seeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach (range(1, 25) as $n) {
            CourseBlock::updateOrCreate(['course_id' => $course->id, 'number' => $n], ['title' => 'Блок '.$n, 'is_active' => true]);
        }
        ...
        foreach (range(1, 25) as $n) {
            Tariff::updateOrCreate(['course_id' => $course->id, 'type' => 'block', 'block_number' => $n, 'block_half' => null], ['title' => 'Блок '.$n, 'price' => 8000, 'is_active' => true]);
        }
