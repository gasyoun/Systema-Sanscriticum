...
| [KONSULTACIYA_REDESIGN_DIRECTIONS_30.07.26.md](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/marketing/marathon-2026-08/KONSULTACIYA_REDESIGN_DIRECTIONS_30.07.26.md) | H1966: 4 visual directions A–D + recommend B; implementer notes | Human `@DECIDE` then Sonnet blade PR — **not** live CSS yet |
| [redesign/](https://github.com/gasyoun/Systema-Sanscriticum/tree/main/marketing/marathon-2026-08/redesign) | Static HTML mockups A–D + `/useit` Nielsen pass | Open HTML in browser; design-only |
