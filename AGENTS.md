...
[generated-block: repo-context — do not hand-edit; regenerated by Uprava tools/gen_repo_context.py; content-hash: 45b8e93a0e]
...
- Cross-repo data edges (from [Uprava interlinks_edges.tsv](https://github.com/gasyoun/Uprava/blob/main/interlinks_edges.tsv)):
  ...
  - vendors → `message-intent-classifier`: pinned vendored classifier engine + rules/v1 + taxonomy/v1 + golden vectors (PINNED_SHA e3320e671e03) (live)
  - consumes → `message-intent-classifier`: CONSUMER side of the frozen MASKED eval dialogue snapshot corpora/eval/2026-07-05-masked.jsonl (export 05-07-2026, 2621 dialogues) (queued)
  - consumes → `message-intent-classifier`: CONSUMER side of the MASKED train dialogue snapshot corpora/train/2026-08-22-masked.jsonl (snapshot 22-08-2026, 2776 dialogues) (queued)
