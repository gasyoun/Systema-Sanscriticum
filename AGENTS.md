...
[generated-block: repo-context — do not hand-edit; regenerated by Uprava tools/gen_repo_context.py; content-hash: 895515ca7e]
...
- Task routing: [CLAUDE.md](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/CLAUDE.md) — open the matching section; do not read the file end-to-end. Sections: Stack · Ops / uptime (production) · Editorial style guide of record (RU copy) · Commands · Architecture · External Integrations · Environment Notes · Operational hazard notes.
