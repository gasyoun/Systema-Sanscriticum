...
[generated-block: repo-context — do not hand-edit; regenerated by Uprava tools/gen_repo_context.py; content-hash: eff3800fb7]
...
- Task routing: [CLAUDE.md](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/CLAUDE.md) — open the matching section; do not read the file end-to-end. Sections: Stack · Watcher (always-on) · Money contour (always-on) · Deploy / soft-alert (always-on) · CRM homework-pause · Editorial style (RU copy) · Commands · Architecture (routing) · External integrations · Environment / worktrees · Operational hazards.
