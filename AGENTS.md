...
[generated-block: repo-context — do not hand-edit; regenerated by Uprava tools/gen_repo_context.py; content-hash: 82a82a9578]
...
- The curated context of record for this repo is [CLAUDE.md](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/CLAUDE.md) — read it in full. Its sections: Stack · Ops / uptime (production) · Editorial style guide of record (RU copy) · Commands · Architecture · External Integrations · Environment Notes · Operational hazard notes.
