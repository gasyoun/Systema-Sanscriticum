...
return [
    ...
    */
    ...
    'telegram_support' => [
        ...
        // НЕ ниже 13: DeliverSupportReply::backoff() = [30,120,600] — это
        // 12,5 минуты законных повторов, и меньший порог красил бы здоровые
        // сообщения. Это оттенок текста, а не отдельное состояние доставки.
