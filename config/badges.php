...
return [
    ...
    */
    'catalog' => [
        ...
        ['key' => 'mentor',        'name' => 'Наставник',         'icon' => '🤝', 'desc' => 'Приглашенный друг оплатил курс',   'metric' => 'referrals',         'threshold' => 1],
        ['key' => 'ambassador',    'name' => 'Амбассадор',        'icon' => '🌟', 'desc' => 'Трое приглашенных оплатили курс',  'metric' => 'referrals',         'threshold' => 3],
