...
| Ledger feature tests on MariaDB (after the review fixes) | `OK (47 tests, 518 assertions)` |
...
The final re-review verdict is recorded in the handoff's `## Verifier` section.
