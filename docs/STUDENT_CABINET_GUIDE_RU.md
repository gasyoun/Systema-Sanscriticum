...
_Created: 21-08-2026 · Last updated: 14-09-2026_
<!-- manuals: enforcement=coverage-test -->  <!-- kept green by StudentCabinetGuideCoverageTest -->
<!-- md-hygiene: Last updated bump 14-09-2026 = Часть I: 9-й сценарий «Предупредить о задержке оплаты» (объявление о блоках 14-09-2026, рулинг MG) — H4434 преемник -->
...
- **Часть I. Сценарии** — девять задач, которые встречаются чаще всего
  ...
  - [Предупредить о задержке оплаты](#предупредить-о-задержке-оплаты)
...
## Предупредить о задержке оплаты

**Что получится.** Доступ сохраняется, а куратор знает, к какому числу ждать оплату.

### Шаги

1. Как только стало ясно, что к сроку оплатить не успеете, предупредите — до ограничения доступа, не после.
2. Напишите куратору любым способом: в кабинете ([Позвать куратора](#позвать-куратора)), в Telegram [@rusamskrtam](https://t.me/rusamskrtam) или на почту [institutsanskrita@ya.ru](mailto:institutsanskrita@ya.ru).
3. В сообщении назовите курс или группу и **дату, когда внесёте оплату** — например: «Грамматика гр.61, оплачу до 28.09».
4. Дождитесь ответа с **входящим номером обращения** — предупреждение считается принятым только с ним.
5. Доступ сохраняется до оговорённой даты; к ней — оплата или новое предупреждение с новой датой.

### Если пошло не так

- **Ответа нет больше суток.** Напишите ещё раз другим каналом: письмо могло попасть в «Спам».
- **Доступ уже ограничили.** Предупреждение всё в силе: после ответа куратора с номером обращения доступ вернут.
...
**Я живу не в Москве — какое время показано?**
На главной кабинете есть карточка **«Ваше время»**. Кабинет определяет пояс по часам
вашего устройства автоматически; рядом с московским временем занятия появится ваше
местное («11:00 МСК · 16:00 ваше»). Занятия всегда идут по московскому времени —
меняется только цифра рядом.

**Уезжаю на месяц в другую страну — время будет неверное?**
Нет. Откройте **«Ваше время» → «Изменить»** и в блоке «Я временно в другой стране»
выберите страну и дату возвращения. На этот срок кабинет покажет время той страны,
а потом сам вернётся к постоянному поясу — ничего напоминать не нужно.

**В моей стране переводят часы — я опоздаю на занятие?**
Школа предупредит заранее: **за неделю**, **вечером накануне** и **за час до занятия**.
Сообщение придёт в Telegram (если привязан) или на email. Местное время занятия после
перевода часов изменится — московское останется прежним. Проверьте будильник.

**Подписка на календарь — что это даёт?**
На вкладке **«Расписание»** кнопка **«Добавить в календарь»**: занятия появляются
в вашем Google/Apple календаре и обновляются сами, уже в вашем местном времени.
Подписка не приходит за час — используйте её как план, а напоминания школы как будильник.
