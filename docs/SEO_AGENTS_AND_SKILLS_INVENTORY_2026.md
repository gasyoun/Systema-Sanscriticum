...
> **Пакет из 18 SEO-субагентов (слой 1) — RETIRED 16-09-2026 (H5028).** Решение МГ, Q3 грилла по цифровому маркетингу 16-09-2026 — «Kill n8n + SEO subagents, restart factory + wiki» ([документ решений](https://github.com/gasyoun/Uprava/blob/main/docs/DECISIONS_DIGITAL_MARKETING_GRILL_16-09-2026.md)): субагенты упирались в лимит ходов, а факты аудита H2 пришли из сырого `curl`. Скиллы `/seo-*` (слой 2) остаются в работе; снята только рамка «пакет субагентов» — §1 ниже сохранён как историческая справка.
