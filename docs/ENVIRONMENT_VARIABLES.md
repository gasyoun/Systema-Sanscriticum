...
| `HINDI_ATTACHMENT_DRILLS` | optional | `false` | config/features.php:952 |
| `HINDI_DICTIONARY_DRILLS` | optional | `false` | config/features.php:978 |
| `HINDI_MY_SRS_DECK` | optional | `false` | config/features.php:961 |
...
| `HINDI_TG_CURATED_PRACTICE` | optional | `false` | config/features.php:970 |
| `HINDI_TRANSCRIPT_DRILLS` | optional | `false` | config/features.php:934 |
| `HINDI_YOUTUBE_NOVA3_DRILLS` | optional | `false` | config/features.php:943 |
