...
| `HOMEWORK_AUTO_OPEN_ALIGN_HOUR` | optional | `9` | config/homework.php:217 |
| `HOMEWORK_AUTO_OPEN_CHANNELS` | optional | `'telegram,vk'` | config/homework.php:223 |
| `HOMEWORK_AUTO_OPEN_CLOSE_PREVIOUS` | optional | `false` | config/homework.php:228 |
| `HOMEWORK_AUTO_OPEN_COURSES` | optional | `''` | config/homework.php:175 |
| `HOMEWORK_AUTO_OPEN_DELAY_HOURS` | optional | `12` | config/homework.php:214 |
| `HOMEWORK_AUTO_OPEN_ENABLED` | feature-flag | `true` | config/homework.php:141 |
| `HOMEWORK_AUTO_OPEN_EXCLUDE_COURSES` | optional | `''` | config/homework.php:160 |
| `HOMEWORK_AUTO_OPEN_EXCLUDE_PREFIXES` | optional | `'ctenie-'` | config/homework.php:169 |
| `HOMEWORK_AUTO_OPEN_GENERIC_COURSES` | optional | `''` | config/homework.php:255 |
| `HOMEWORK_AUTO_OPEN_GENERIC_IMMEDIATE` | optional | `true` | config/homework.php:264 |
| `HOMEWORK_AUTO_OPEN_GENERIC_PROMPT` | optional | `'Домашнее задание',` | config/homework.php:258 |
| `HOMEWORK_AUTO_OPEN_KOCHERGINA_MAX` | optional | `5` | config/homework.php:187 |
| `HOMEWORK_AUTO_OPEN_KOCHERGINA_PREFIX` | optional | `'grammatika-po-kocerginoi-'` | config/homework.php:181 |
| `HOMEWORK_AUTO_OPEN_LESSONS` | optional | `'1,2,3,4,5'` | config/homework.php:209 |
| `HOMEWORK_AUTO_OPEN_MIN_COURSE_START` | optional | `'2026-06-01'` | config/homework.php:150 |
| `HOMEWORK_AUTO_OPEN_MISSING_MAPPING_ALERT` | optional | `true` | config/homework.php:202 |
| `HOMEWORK_AUTO_OPEN_POLICY_EPOCH` | optional | `'2026-08-18'` | config/homework.php:155 |
| `HOMEWORK_AUTO_OPEN_SCOPE` | optional | `'all'` | config/homework.php:146 |
| `HOMEWORK_AUTO_OPEN_WITHOUT_TEXTBOOK_LESSON` | optional | `true` | config/homework.php:198 |
...
| `HOMEWORK_TG_TAG_ENABLED` | feature-flag | `true` | config/homework.php:283 |
| `HOMEWORK_TG_TAG_LOOKBACK_HOURS` | optional | `72` | config/homework.php:286 |
| `HOMEWORK_TG_TAG_PENDING_TTL` | optional | `60` | config/homework.php:292 |
| `HOMEWORK_TG_TAG_POST_OPEN_INVITE` | optional | `true` | config/homework.php:289 |
...
| `KOCHERGINA_SOURCE_PATH` | optional | `base_path('../SanskritGrammar/KocherginaUchebnik_1998/Kochergina_un…` | config/homework.php:233 |
