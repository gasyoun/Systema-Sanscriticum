...
| `ATTENDANCE_DASHBOARD` | optional | `false` | config/features.php:253 |
| `ATTENDANCE_DEFAULT_WINDOW_DAYS` | optional | `90` | config/attendance.php:20 |
| `ATTENDANCE_NOTICES` | optional | `false` | config/features.php:262 |
...
| `CHECKOUT_REFERRAL_CREDIT_LOCK` | optional | `true` | config/features.php:366 |
| `CHECKOUT_SESSION_LAPSE_RELOGIN` | optional | `true` | config/features.php:456 |
| `CHECKOUT_SIGNED_RETURN_URL` | optional | `true` | config/features.php:471 |
| `CHECKOUT_STALE_ORDER_EXPIRY` | optional | `true` | config/features.php:392 |
...
| `CLIP_MARKETING_ENABLED` | feature-flag | `false` | config/features.php:517 |
...
| `CLUB_MEMBERSHIP` | optional | `false` | config/features.php:877 |
| `COMPANY_INVOICE_ENABLED` | feature-flag | `false` | config/billing.php:17 |
| `CONTENT_AUTO_PUBLISH_PILOT` | feature-flag | `false` | config/features.php:563 |
| `CONTENT_CALENDAR_AUTOPILOT` | optional | `false` | config/features.php:543 |
| `CONTENT_CALENDAR_ENABLED` | feature-flag | `false` | config/features.php:537 |
| `CONTENT_CLIP_RANK_N` | optional | `5` | config/content.php:21 |
| `CONTENT_EMAIL_ONESHOT` | optional | `false` | config/features.php:571 |
| `CONTENT_FORWARD_DRAFT_MAX_PER_RUN` | optional | `10` | config/content.php:43 |
| `CONTENT_FROM_LECTURES` | optional | `false` | config/features.php:528 |
...
| `COURSE_LIBRARY` | optional | `false` | config/features.php:844 |
...
| `CRM_FOLLOW_UP_TASKS` | optional | `false` | config/features.php:650 |
...
| `CRM_PIPELINE_BOARD` | optional | `false` | config/features.php:597 |
...
| `DOZHIM_DRIP` | optional | `false` | config/features.php:675 |
| `DOZHIM_QUEUE` | optional | `false` | config/features.php:661 |
...
| `FLAGSHIP_CTA_AB` | optional | `false` | config/features.php:989 |
...
| `GAMES_SKILL_DRILLS` | optional | `false` | config/features.php:722 |
...
| `GRAMMAR_LAB` | optional | `false` | config/features.php:903 |
...
| `GRAMMAR_LAB_PILOT` | feature-flag | `false` | config/features.php:917 |
...
| `GRAMMAR_LAB_SEMANTIC` | optional | `false` | config/features.php:910 |
| `GRAMMAR_LAB_SUBSCRIPTION_COURSE_SLUG` | optional | `''` | config/grammar_lab.php:53 |
| `GRANT_ACCESS_FAIL_CLOSED` | optional | `false` | config/features.php:431 |
...
| `HINDI_ATTACHMENT_DRILLS` | optional | `false` | config/features.php:943 |
| `HINDI_MY_SRS_DECK` | optional | `false` | config/features.php:952 |
...
| `HUB_TRANSLITERATE` | optional | `false` | config/features.php:215 |
...
| `LEAD_CONVERTED_AT_ON_COURSE_PAID` | optional | `false` | config/features.php:688 |
...
| `MEMBERSHIP_FUNNEL_ANALYTICS` | optional | `false` | config/features.php:894 |
| `MEMBERSHIP_LAUNCH_DATE` | optional | `'2026-09-01'` | config/membership.php:55 |
| `MEMBERSHIP_PRIVATE_ARCHIVES` | optional | `false` | config/features.php:892 |
| `MEMBERSHIP_PUBLIC_FEED` | optional | `false` | config/features.php:890 |
...
| `MEMBERSHIP_RECORDING_ENFORCE` | optional | `false` | config/features.php:886 |
| `MEMBERSHIP_RECORDING_PILOT` | feature-flag | `false` | config/features.php:885 |
...
| `MEMBERSHIP_RECORDING_SHADOW` | optional | `false` | config/features.php:884 |
...
| `MEMBERSHIP_TIERED` | optional | `false` | config/features.php:880 |
| `MEMBERSHIP_TOP` | optional | `false` | config/features.php:883 |
...
| `NEWSLETTER_SUBSCRIBE_ENABLED` | feature-flag | `true` | config/features.php:244 |
...
| `PAYMENT_RECOVERY_CTA` | optional | `false` | config/features.php:701 |
...
| `PAYPAL_SUBSCRIPTIONS_ENABLED` | feature-flag | `false` | config/features.php:786<br>config/services.php:397 |
...
| `RQ4_STUDY` | optional | `false` | config/features.php:228 |
...
| `STAFF_IMPERSONATION` | optional | `false` | config/features.php:777 |
| `START_CHTENIYA_COHORT_ENABLED` | feature-flag | `false` | config/features.php:804 |
...
| `SUPPORT_CAPACITY_ROUTING` | optional | `false` | config/features.php:973 |
| `SUPPORT_DEPARTMENTS` | optional | `false` | config/features.php:972 |
...
| `SUPPORT_FOLLOW_UP_TASKS` | optional | `false` | config/features.php:331 |
...
| `SUPPORT_LEAD_CAPTURE` | optional | `false` | config/features.php:314 |
| `SUPPORT_OBSERVABILITY` | optional | `false` | config/features.php:271 |
...
| `SUPPORT_REQUIRED_CLOSE_TOPIC` | optional | `false` | config/features.php:323 |
...
| `SUPPORT_VISITOR_PRESENCE` | optional | `false` | config/features.php:301 |
| `SUPPORT_WEB_ROLLUPS` | optional | `false` | config/features.php:286 |
...
| `TELEGRAM_ZAPISI_BOT_ENABLED` | feature-flag | `false` | config/features.php:442 |
...
| `TELEPHONY_CALLBACK_REQUEST` | optional | `false` | config/features.php:969 |
| `TELEPHONY_PSTN` | optional | `false` | config/features.php:970 |
| `TELEPHONY_RECORDING` | optional | `false` | config/features.php:971 |
...
| `TOCHKA_RECURRING_ENABLED` | feature-flag | `false` | config/features.php:732 |
| `TOCHKA_RECURRING_MODES` | optional | `'per_course,club,installment'` | config/features.php:740 |
| `TOCHKA_TAX_SYSTEM_CODE` | required | `—` | config/services.php:51 |
| `TOCHKA_VAT_TYPE` | optional | `'none'` | config/services.php:52 |
| `TOCHKA_WEBHOOK_GUARD` | optional | `true` | config/features.php:421 |
...
| `UPGRADE_CREDIT_REFUND_LINK` | optional | `false` | config/features.php:611 |
| `VIDEO_RESUME` | optional | `false` | config/features.php:495 |
...
| `VISUALDCS_NOMINAL` | optional | `false` | config/features.php:854 |
| `VISUALDCS_PAGE_SIZE` | optional | `50` | config/visualdcs.php:21 |
| `VISUALDCS_PASSAGE` | optional | `false` | config/features.php:855 |
| `VISUALDCS_PREVIEW_LIMIT` | optional | `5` | config/visualdcs.php:19 |
| `VISUALDCS_VERB` | optional | `false` | config/features.php:853 |
...
| `ZOOM_AUTO_CREATE` | optional | `false` | config/features.php:628 |
