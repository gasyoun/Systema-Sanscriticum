...
| `ADMIN_EMAIL` | optional | `'pe4kin.85@mail.ru'` | config/services.php:318 |
| `ADMIN_PASSWORD` | secret | `—` | config/services.php:319 |
...
| `CATALOG_NEXT_STEP` | optional | `false` | config/features.php:966 |
...
| `GOOGLE_CLIENT_ID` | required | `—` | config/services.php:365 |
| `GOOGLE_CLIENT_SECRET` | secret | `—` | config/services.php:366 |
| `GOOGLE_REDIRECT_URI` | optional | `'/auth/google/callback'` | config/services.php:367 |
| `GRAMMAR_LAB` | optional | `false` | config/features.php:888 |
...
| `GRAMMAR_LAB_PILOT` | feature-flag | `false` | config/features.php:902 |
...
| `GRAMMAR_LAB_SEMANTIC` | optional | `false` | config/features.php:895 |
...
| `HINDI_ATTACHMENT_DRILLS` | optional | `false` | config/features.php:928 |
| `HINDI_MY_SRS_DECK` | optional | `false` | config/features.php:937 |
...
| `HINDI_PROGRAMME_PLAYLIST` | optional | `false` | config/features.php:911 |
| `HINDI_TG_CURATED_PRACTICE` | optional | `false` | config/features.php:946 |
| `HINDI_TRANSCRIPT_DRILLS` | optional | `false` | config/features.php:919 |
| `HOMEWORK_AUTO_OPEN_ALIGN_HOUR` | optional | `9` | config/homework.php:152 |
| `HOMEWORK_AUTO_OPEN_CHANNELS` | optional | `'telegram,vk'` | config/homework.php:158 |
| `HOMEWORK_AUTO_OPEN_CLOSE_PREVIOUS` | optional | `false` | config/homework.php:163 |
| `HOMEWORK_AUTO_OPEN_COURSES` | optional | `''` | config/homework.php:136 |
| `HOMEWORK_AUTO_OPEN_DELAY_HOURS` | optional | `12` | config/homework.php:149 |
| `HOMEWORK_AUTO_OPEN_ENABLED` | feature-flag | `true` | config/homework.php:131 |
| `HOMEWORK_AUTO_OPEN_GENERIC_COURSES` | optional | `''` | config/homework.php:190 |
| `HOMEWORK_AUTO_OPEN_GENERIC_IMMEDIATE` | optional | `true` | config/homework.php:199 |
| `HOMEWORK_AUTO_OPEN_GENERIC_PROMPT` | optional | `'Домашнее задание',` | config/homework.php:193 |
| `HOMEWORK_AUTO_OPEN_LESSONS` | optional | `'1,2,3,4,5'` | config/homework.php:144 |
...
| `HOMEWORK_PDF_JPEG_QUALITY` | optional | `80` | config/homework.php:72 |
| `HOMEWORK_PDF_MAX_EDGE_PX` | optional | `1600` | config/homework.php:68 |
| `HOMEWORK_REVIEWERS_ENABLED` | feature-flag | `true` | config/homework.php:96 |
| `HOMEWORK_REVIEWER_CHANNELS` | optional | `'database,mail,telegram'` | config/homework.php:102 |
| `HOMEWORK_REVIEWER_DIGEST_DAY` | optional | `1` | config/homework.php:110 |
| `HOMEWORK_REVIEWER_DIGEST_ENABLED` | feature-flag | `true` | config/homework.php:107 |
| `HOMEWORK_REVIEWER_DIGEST_TIME` | optional | `'09:00'` | config/homework.php:111 |
| `HOMEWORK_TG_TAG_ENABLED` | feature-flag | `true` | config/homework.php:218 |
| `HOMEWORK_TG_TAG_LOOKBACK_HOURS` | optional | `72` | config/homework.php:221 |
| `HOMEWORK_TG_TAG_PENDING_TTL` | optional | `60` | config/homework.php:227 |
| `HOMEWORK_TG_TAG_POST_OPEN_INVITE` | optional | `true` | config/homework.php:224 |
...
| `KOCHERGINA_SOURCE_PATH` | optional | `base_path('../SanskritGrammar/KocherginaUchebnik_1998/Kochergina_un…` | config/homework.php:168 |
...
| `LECTURE_BUILDER_AI_TIMEOUT` | optional | `600` | config/services.php:343 |
| `LECTURE_BUILDER_TIMEOUT` | optional | `180` | config/services.php:341 |
| `LECTURE_BUILDER_TOKEN` | secret | `—` | config/services.php:340 |
| `LECTURE_BUILDER_URL` | optional | `'http://127.0.0.1:5001'` | config/services.php:339 |
...
| `MEMBERSHIP_CANCELLATION` | optional | `false` | config/features.php:879 |
| `MEMBERSHIP_FREE_TIER` | optional | `false` | config/features.php:878 |
...
| `OPENROUTER_API_KEY` | secret | `—` | config/services.php:303 |
| `OPENROUTER_BASE_URL` | optional | `'https://openrouter.ai/api/v1'` | config/services.php:304 |
| `OPENROUTER_MODEL` | optional | `'deepseek/deepseek-v4-flash'` | config/services.php:305 |
| `OPENROUTER_PRICE_DEEPSEEK_CHAT_COMPLETION` | optional | `0.8001` | config/services.php:312 |
| `OPENROUTER_PRICE_DEEPSEEK_CHAT_PROMPT` | optional | `0.2002` | config/services.php:311 |
...
| `PAYPAL_API_BASE_URL` | required | `—` | config/services.php:400 |
| `PAYPAL_API_MODE` | optional | `'sandbox'` | config/services.php:394 |
| `PAYPAL_CLAIM_ENABLED` | feature-flag | `false` | config/services.php:386 |
| `PAYPAL_CLIENT_ID` | required | `—` | config/services.php:395 |
| `PAYPAL_CLIENT_SECRET` | secret | `—` | config/services.php:396 |
| `PAYPAL_ME_LINK` | required | `—` | config/services.php:387 |
| `PAYPAL_RECIPIENT` | required | `—` | config/services.php:388 |
| `PAYPAL_SKIP_WEBHOOK_SIGNATURE` | optional | `false` | config/services.php:399 |
| `PAYPAL_SUBSCRIPTIONS_ENABLED` | feature-flag | `false` | config/features.php:786<br>config/services.php:393 |
| `PAYPAL_WEBHOOK_ID` | required | `—` | config/services.php:397 |
...
| `SMS_RU_API_ID` | required | `—` | config/services.php:293 |
...
| `SUPPORT_CAPACITY_ROUTING` | optional | `false` | config/features.php:958 |
| `SUPPORT_DEPARTMENTS` | optional | `false` | config/features.php:957 |
...
| `SUPPORT_TECH_ASSIGNEE_USER_ID` | required | `—` | config/services.php:169<br>config/services.php:170<br>config/support_tech.php:10<br>config/support_tech.php:11 |
...
| `TELEGRAM_HARVEST_ACCOUNT_NAME` | optional | `'harvester'` | config/services.php:189 |
| `TELEGRAM_HARVEST_CORPUS_SILENCE_AFTER_HOURS` | optional | `48` | config/services.php:210 |
| `TELEGRAM_HARVEST_DAILY_CRON` | optional | `'15 5,17 * * *'` | config/services.php:187 |
| `TELEGRAM_HARVEST_DAILY_ENABLED` | feature-flag | `false` | config/services.php:186 |
| `TELEGRAM_HARVEST_ENABLED` | feature-flag | `false` | config/services.php:185 |
| `TELEGRAM_HARVEST_HISTORY_LIMIT` | optional | `200` | config/services.php:190 |
| `TELEGRAM_HARVEST_MEDIA_DOWNLOAD_PEERS` | optional | `''` | config/services.php:225 |
| `TELEGRAM_HARVEST_PEERS` | optional | `''` | config/services.php:192 |
| `TELEGRAM_HARVEST_PEERS_FILE` | required | `—` | config/services.php:194 |
| `TELEGRAM_HARVEST_PEER_DELAY_MAX` | optional | `0` | config/services.php:220 |
| `TELEGRAM_HARVEST_PEER_DELAY_MIN` | optional | `0` | config/services.php:219 |
| `TELEGRAM_HARVEST_ROSTER_STALE_AFTER_HOURS` | optional | `6` | config/services.php:205 |
| `TELEGRAM_HARVEST_ROSTER_TIMEOUT_SECONDS` | optional | `600` | config/services.php:216 |
| `TELEGRAM_HARVEST_STORE_PATH` | required | `—` | config/services.php:200 |
...
| `TELEGRAM_WEBHOOK_CERTIFICATE` | required | `—` | config/services.php:246 |
| `TELEGRAM_ZAPISI_BOT_ENABLED` | feature-flag | `false` | config/features.php:442 |
| `TELEGRAM_ZAPISI_POLL_ENABLED` | feature-flag | `false` | config/services.php:262 |
| `TELEGRAM_ZAPISI_POLL_MAX_LIFETIME_SECONDS` | optional | `3600` | config/services.php:268 |
| `TELEGRAM_ZAPISI_POLL_RETRY_SECONDS` | optional | `10` | config/services.php:271 |
| `TELEGRAM_ZAPISI_POLL_TIMEOUT_SECONDS` | optional | `50` | config/services.php:265 |
| `TELEPHONY_CALLBACK_REQUEST` | optional | `false` | config/features.php:954 |
| `TELEPHONY_PSTN` | optional | `false` | config/features.php:955 |
| `TELEPHONY_RECORDING` | optional | `false` | config/features.php:956 |
| `TEST_MANAGER_EMAIL` | optional | `'smoke-manager@samskrte.ru'` | config/services.php:325 |
| `TEST_MANAGER_NAME` | optional | `'Smoke Manager'` | config/services.php:327 |
| `TEST_MANAGER_PASSWORD` | secret | `—` | config/services.php:326 |
| `TEST_STUDENT_EMAIL` | optional | `'smoke-student@samskrte.ru'` | config/services.php:333 |
| `TEST_STUDENT_NAME` | optional | `'Smoke Student'` | config/services.php:335 |
| `TEST_STUDENT_PASSWORD` | secret | `—` | config/services.php:334 |
...
| `VK_BOT_TOKEN` | secret | `—` | config/services.php:275 |
| `VK_CALLBACK_SECRET` | secret | `—` | config/services.php:280 |
| `VK_CLIENT_ID` | required | `—` | config/services.php:370 |
| `VK_CLIENT_SECRET` | secret | `—` | config/services.php:371 |
| `VK_CONFIRM_CODE` | required | `—` | config/services.php:277 |
| `VK_GROUP_ID` | required | `—` | config/services.php:276 |
| `VK_ORS_DATA_PATH` | optional | `storage_path('app/vk_ors')` | config/content.php:14 |
| `VK_REDIRECT_URI` | optional | `'/auth/vkontakte/callback'` | config/services.php:372 |
| `YANDEX_AGENT_ID` | required | `—` | config/services.php:286 |
| `YANDEX_API_KEY` | secret | `—` | config/services.php:284 |
| `YANDEX_CLIENT_ID` | required | `—` | config/services.php:375 |
| `YANDEX_CLIENT_SECRET` | secret | `—` | config/services.php:376 |
...
| `YANDEX_FOLDER_ID` | required | `—` | config/services.php:285 |
...
| `YANDEX_REDIRECT_URI` | optional | `'/auth/yandex/callback'` | config/services.php:377 |
| `ZOOM_ACCOUNT_ID` | required | `—` | config/services.php:351 |
| `ZOOM_AUTO_CREATE` | optional | `false` | config/features.php:628 |
| `ZOOM_CLIENT_ID` | required | `—` | config/services.php:352 |
| `ZOOM_CLIENT_SECRET` | secret | `—` | config/services.php:353 |
| `ZOOM_TIMEOUT` | optional | `30` | config/services.php:354 |
| `ZOOM_WEBHOOK_SECRET` | secret | `—` | config/services.php:357 |
