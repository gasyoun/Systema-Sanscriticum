...
| `CABINET_HYBRID` | optional | `false` | config/features.php:515 |
...
| `CHECKOUT_DEPOSIT_REVERSAL` | optional | `true` | config/features.php:336 |
| `CHECKOUT_INACTIVE_TARIFF_GUARD` | optional | `true` | config/features.php:319 |
| `CHECKOUT_INTEGRITY_SAFE_REPAIRS` | optional | `false` | config/features.php:311 |
...
| `CHECKOUT_PROMO_RESERVATIONS` | optional | `true` | config/features.php:303 |
| `CHECKOUT_PROMO_SURVIVES_SESSION` | optional | `true` | config/features.php:370 |
| `CHECKOUT_REFERRAL_CREDIT_LOCK` | optional | `true` | config/features.php:327 |
| `CHECKOUT_SESSION_LAPSE_RELOGIN` | optional | `true` | config/features.php:417 |
| `CHECKOUT_SIGNED_RETURN_URL` | optional | `true` | config/features.php:432 |
| `CHECKOUT_STALE_ORDER_EXPIRY` | optional | `true` | config/features.php:353 |
...
| `CLIP_MARKETING_ENABLED` | feature-flag | `false` | config/features.php:478 |
| `COMPANY_INVOICE_ENABLED` | feature-flag | `false` | config/billing.php:17 |
| `CONTENT_AUTO_PUBLISH_PILOT` | feature-flag | `false` | config/features.php:524 |
| `CONTENT_CALENDAR_AUTOPILOT` | optional | `false` | config/features.php:504 |
| `CONTENT_CALENDAR_ENABLED` | feature-flag | `false` | config/features.php:498 |
| `CONTENT_CLIP_RANK_N` | optional | `5` | config/content.php:21 |
| `CONTENT_EMAIL_ONESHOT` | optional | `false` | config/features.php:532 |
| `CONTENT_FORWARD_DRAFT_MAX_PER_RUN` | optional | `10` | config/content.php:43 |
| `CONTENT_FROM_LECTURES` | optional | `false` | config/features.php:489 |
...
| `CRM_FOLLOW_UP_TASKS` | optional | `false` | config/features.php:611 |
| `CRM_PIPELINE_BOARD` | optional | `false` | config/features.php:558 |
...
| `DOZHIM_DRIP` | optional | `false` | config/features.php:636 |
| `DOZHIM_QUEUE` | optional | `false` | config/features.php:622 |
...
| `EMAIL_CAMPAIGNS` | optional | `false` | config/features.php:444 |
...
| `GRANT_ACCESS_FAIL_CLOSED` | optional | `false` | config/features.php:392 |
...
| `KINESCOPE_PILOT` | feature-flag | `false` | config/features.php:465 |
...
| `LEAD_CONVERTED_AT_ON_COURSE_PAID` | optional | `false` | config/features.php:649 |
...
| `MARKETING_SEGMENTS` | optional | `false` | config/features.php:544 |
...
| `PAYMENT_RECOVERY_CTA` | optional | `false` | config/features.php:662 |
...
| `SUPPORT_FOLLOW_UP_TASKS` | optional | `false` | config/features.php:292 |
...
| `SUPPORT_REQUIRED_CLOSE_TOPIC` | optional | `false` | config/features.php:284 |
...
| `TELEGRAM_ZAPISI_BOT_ENABLED` | feature-flag | `false` | config/features.php:403 |
...
| `UPGRADE_CREDIT_REFUND_LINK` | optional | `false` | config/features.php:572 |
| `VIDEO_RESUME` | optional | `false` | config/features.php:456 |
...
| `ZOOM_AUTO_CREATE` | optional | `false` | config/features.php:589 |
