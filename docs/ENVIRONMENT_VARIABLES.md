...
| `ADMIN_EMAIL` | optional | `'pe4kin.85@mail.ru'` | config/services.php:309 |
| `ADMIN_PASSWORD` | secret | `—` | config/services.php:310 |
...
| `CATALOG_NEXT_STEP` | optional | `false` | config/features.php:949 |
...
| `CLUB_MEMBERSHIP` | optional | `false` | config/features.php:860 |
...
| `COURSE_LIBRARY` | optional | `false` | config/features.php:827 |
...
| `FLAGSHIP_CTA_AB` | optional | `false` | config/features.php:957 |
...
| `GOOGLE_CLIENT_ID` | required | `—` | config/services.php:356 |
| `GOOGLE_CLIENT_SECRET` | secret | `—` | config/services.php:357 |
| `GOOGLE_REDIRECT_URI` | optional | `'/auth/google/callback'` | config/services.php:358 |
| `GRAMMAR_LAB` | optional | `false` | config/features.php:871 |
...
| `GRAMMAR_LAB_PILOT` | feature-flag | `false` | config/features.php:885 |
...
| `GRAMMAR_LAB_SEMANTIC` | optional | `false` | config/features.php:878 |
...
| `HINDI_ATTACHMENT_DRILLS` | optional | `false` | config/features.php:911 |
| `HINDI_MY_SRS_DECK` | optional | `false` | config/features.php:920 |
...
| `HINDI_PROGRAMME_PLAYLIST` | optional | `false` | config/features.php:894 |
| `HINDI_TG_CURATED_PRACTICE` | optional | `false` | config/features.php:929 |
| `HINDI_TRANSCRIPT_DRILLS` | optional | `false` | config/features.php:902 |
...
| `LECTURE_BUILDER_AI_TIMEOUT` | optional | `600` | config/services.php:334 |
| `LECTURE_BUILDER_TIMEOUT` | optional | `180` | config/services.php:332 |
| `LECTURE_BUILDER_TOKEN` | secret | `—` | config/services.php:331 |
| `LECTURE_BUILDER_URL` | optional | `'http://127.0.0.1:5001'` | config/services.php:330 |
...
| `MANAGER_SALES_REPORT` | optional | `false` | config/features.php:805 |
...
| `MEMBERSHIP_CANCELLATION` | optional | `false` | config/features.php:862 |
| `MEMBERSHIP_FREE_TIER` | optional | `false` | config/features.php:861 |
...
| `OPENROUTER_API_KEY` | secret | `—` | config/services.php:294 |
| `OPENROUTER_BASE_URL` | optional | `'https://openrouter.ai/api/v1'` | config/services.php:295 |
| `OPENROUTER_MODEL` | optional | `'deepseek/deepseek-v4-flash'` | config/services.php:296 |
| `OPENROUTER_PRICE_DEEPSEEK_CHAT_COMPLETION` | optional | `0.8001` | config/services.php:303 |
| `OPENROUTER_PRICE_DEEPSEEK_CHAT_PROMPT` | optional | `0.2002` | config/services.php:302 |
...
| `PAYPAL_API_BASE_URL` | required | `—` | config/services.php:391 |
| `PAYPAL_API_MODE` | optional | `'sandbox'` | config/services.php:385 |
| `PAYPAL_CLAIM_ENABLED` | feature-flag | `false` | config/services.php:377 |
| `PAYPAL_CLIENT_ID` | required | `—` | config/services.php:386 |
| `PAYPAL_CLIENT_SECRET` | secret | `—` | config/services.php:387 |
| `PAYPAL_ME_LINK` | required | `—` | config/services.php:378 |
| `PAYPAL_RECIPIENT` | required | `—` | config/services.php:379 |
| `PAYPAL_SKIP_WEBHOOK_SIGNATURE` | optional | `false` | config/services.php:390 |
| `PAYPAL_SUBSCRIPTIONS_ENABLED` | feature-flag | `false` | config/features.php:769<br>config/services.php:384 |
| `PAYPAL_WEBHOOK_ID` | required | `—` | config/services.php:388 |
...
| `SMS_RU_API_ID` | required | `—` | config/services.php:284 |
...
| `STAFF_IMPERSONATION` | optional | `false` | config/features.php:760 |
| `START_CHTENIYA_COHORT_ENABLED` | feature-flag | `false` | config/features.php:787 |
...
| `SUPPORT_CAPACITY_ROUTING` | optional | `false` | config/features.php:941 |
| `SUPPORT_DEPARTMENTS` | optional | `false` | config/features.php:940 |
...
| `SUPPORT_TECH_ASSIGNEE_USER_ID` | required | `—` | config/services.php:160<br>config/services.php:161<br>config/support_tech.php:10<br>config/support_tech.php:11 |
...
| `TELEGRAM_HARVEST_ACCOUNT_NAME` | optional | `'harvester'` | config/services.php:180 |
| `TELEGRAM_HARVEST_CORPUS_SILENCE_AFTER_HOURS` | optional | `48` | config/services.php:201 |
| `TELEGRAM_HARVEST_DAILY_CRON` | optional | `'15 5,17 * * *'` | config/services.php:178 |
| `TELEGRAM_HARVEST_DAILY_ENABLED` | feature-flag | `false` | config/services.php:177 |
| `TELEGRAM_HARVEST_ENABLED` | feature-flag | `false` | config/services.php:176 |
| `TELEGRAM_HARVEST_HISTORY_LIMIT` | optional | `200` | config/services.php:181 |
| `TELEGRAM_HARVEST_MEDIA_DOWNLOAD_PEERS` | optional | `''` | config/services.php:216 |
| `TELEGRAM_HARVEST_PEERS` | optional | `''` | config/services.php:183 |
| `TELEGRAM_HARVEST_PEERS_FILE` | required | `—` | config/services.php:185 |
| `TELEGRAM_HARVEST_PEER_DELAY_MAX` | optional | `0` | config/services.php:211 |
| `TELEGRAM_HARVEST_PEER_DELAY_MIN` | optional | `0` | config/services.php:210 |
| `TELEGRAM_HARVEST_ROSTER_STALE_AFTER_HOURS` | optional | `6` | config/services.php:196 |
| `TELEGRAM_HARVEST_ROSTER_TIMEOUT_SECONDS` | optional | `600` | config/services.php:207 |
| `TELEGRAM_HARVEST_STORE_PATH` | required | `—` | config/services.php:191 |
...
| `TELEGRAM_SUPPORT_AUTO_HEAL` | optional | `false` | config/services.php:156 |
| `TELEGRAM_SUPPORT_AUTO_HEAL_COOLDOWN_MINUTES` | optional | `30` | config/services.php:157 |
...
| `TELEGRAM_SUPPORT_PENDING_STALE_AFTER_MINUTES` | optional | `15` | config/services.php:146 |
...
| `TELEGRAM_SUPPORT_SYNC_TIMEOUT_SECONDS` | optional | `120` | config/services.php:152 |
| `TELEGRAM_SUPPORT_TECH_GROUP_PEERS` | optional | `''` | config/services.php:165<br>config/support_tech.php:20 |
| `TELEGRAM_SUPPORT_USERNAME` | optional | `''` | config/services.php:167<br>config/support_tech.php:28 |
| `TELEGRAM_WEBHOOK_BASE_URL` | required | `—` | config/services.php:233 |
| `TELEGRAM_WEBHOOK_CERTIFICATE` | required | `—` | config/services.php:237 |
| `TELEGRAM_ZAPISI_BOT_ENABLED` | feature-flag | `false` | config/features.php:442 |
| `TELEGRAM_ZAPISI_POLL_ENABLED` | feature-flag | `false` | config/services.php:253 |
| `TELEGRAM_ZAPISI_POLL_MAX_LIFETIME_SECONDS` | optional | `3600` | config/services.php:259 |
| `TELEGRAM_ZAPISI_POLL_RETRY_SECONDS` | optional | `10` | config/services.php:262 |
| `TELEGRAM_ZAPISI_POLL_TIMEOUT_SECONDS` | optional | `50` | config/services.php:256 |
| `TELEPHONY_CALLBACK_REQUEST` | optional | `false` | config/features.php:937 |
| `TELEPHONY_PSTN` | optional | `false` | config/features.php:938 |
| `TELEPHONY_RECORDING` | optional | `false` | config/features.php:939 |
| `TEST_MANAGER_EMAIL` | optional | `'smoke-manager@samskrte.ru'` | config/services.php:316 |
| `TEST_MANAGER_NAME` | optional | `'Smoke Manager'` | config/services.php:318 |
| `TEST_MANAGER_PASSWORD` | secret | `—` | config/services.php:317 |
| `TEST_STUDENT_EMAIL` | optional | `'smoke-student@samskrte.ru'` | config/services.php:324 |
| `TEST_STUDENT_NAME` | optional | `'Smoke Student'` | config/services.php:326 |
| `TEST_STUDENT_PASSWORD` | secret | `—` | config/services.php:325 |
...
| `VISUALDCS_NOMINAL` | optional | `false` | config/features.php:837 |
| `VISUALDCS_PASSAGE` | optional | `false` | config/features.php:838 |
| `VISUALDCS_PREVIEW_LIMIT` | optional | `5` | config/visualdcs.php:19 |
| `VISUALDCS_VERB` | optional | `false` | config/features.php:836 |
| `VK_BOT_TOKEN` | secret | `—` | config/services.php:266 |
| `VK_CALLBACK_SECRET` | secret | `—` | config/services.php:271 |
| `VK_CLIENT_ID` | required | `—` | config/services.php:361 |
| `VK_CLIENT_SECRET` | secret | `—` | config/services.php:362 |
| `VK_CONFIRM_CODE` | required | `—` | config/services.php:268 |
| `VK_GROUP_ID` | required | `—` | config/services.php:267 |
| `VK_ORS_DATA_PATH` | optional | `storage_path('app/vk_ors')` | config/content.php:14 |
| `VK_REDIRECT_URI` | optional | `'/auth/vkontakte/callback'` | config/services.php:363 |
| `YANDEX_AGENT_ID` | required | `—` | config/services.php:277 |
| `YANDEX_API_KEY` | secret | `—` | config/services.php:275 |
| `YANDEX_CLIENT_ID` | required | `—` | config/services.php:366 |
| `YANDEX_CLIENT_SECRET` | secret | `—` | config/services.php:367 |
...
| `YANDEX_FOLDER_ID` | required | `—` | config/services.php:276 |
...
| `YANDEX_REDIRECT_URI` | optional | `'/auth/yandex/callback'` | config/services.php:368 |
| `ZOOM_ACCOUNT_ID` | required | `—` | config/services.php:342 |
| `ZOOM_AUTO_CREATE` | optional | `false` | config/features.php:628 |
| `ZOOM_CLIENT_ID` | required | `—` | config/services.php:343 |
| `ZOOM_CLIENT_SECRET` | secret | `—` | config/services.php:344 |
| `ZOOM_TIMEOUT` | optional | `30` | config/services.php:345 |
| `ZOOM_WEBHOOK_SECRET` | secret | `—` | config/services.php:348 |
