...
| `ATTENDANCE_DASHBOARD` | optional | `false` | config/features.php:214 |
...
| `CABINET_HYBRID` | optional | `false` | config/features.php:500 |
| `CABINET_PROBE_CHECK_GUARDS` | optional | `true` | config/cabinet_probe.php:53 |
| `CABINET_PROBE_CRON` | optional | `'*/15 * * * *'` | config/cabinet_probe.php:38 |
| `CABINET_PROBE_HISTORY_KEEP` | optional | `500` | config/cabinet_probe.php:43 |
...
| `CABINET_PROBE_TELEGRAM_COOLDOWN` | optional | `60` | config/cabinet_probe.php:29<br>config/cabinet_probe.php:35 |
| `CABINET_PROBE_TELEGRAM_SOFT_CHAT_ID` | optional | `''` | config/cabinet_probe.php:26 |
| `CABINET_PROBE_TELEGRAM_SOFT_COOLDOWN` | optional | `env('CABINET_PROBE_TELEGRAM_COOLDOWN', 60),` | config/cabinet_probe.php:33 |
| `CABINET_PROBE_TIMEOUT` | optional | `15` | config/cabinet_probe.php:40 |
...
| `CHECKOUT_DEPOSIT_REVERSAL` | optional | `true` | config/features.php:310 |
| `CHECKOUT_INACTIVE_TARIFF_GUARD` | optional | `true` | config/features.php:293 |
| `CHECKOUT_INTEGRITY_SAFE_REPAIRS` | optional | `false` | config/features.php:285 |
| `CHECKOUT_LEGACY_PENDING_DAYS` | optional | `30` | config/checkout.php:31 |
| `CHECKOUT_PROMO_RESERVATIONS` | optional | `true` | config/features.php:277 |
| `CHECKOUT_PROMO_SURVIVES_SESSION` | optional | `true` | config/features.php:344 |
| `CHECKOUT_REFERRAL_CREDIT_LOCK` | optional | `true` | config/features.php:301 |
| `CHECKOUT_SESSION_LAPSE_RELOGIN` | optional | `true` | config/features.php:402 |
| `CHECKOUT_SIGNED_RETURN_URL` | optional | `true` | config/features.php:417 |
| `CHECKOUT_STALE_ORDER_EXPIRY` | optional | `true` | config/features.php:327 |
...
| `CLIP_MARKETING_ENABLED` | feature-flag | `false` | config/features.php:463 |
| `COMPANY_INVOICE_ENABLED` | feature-flag | `false` | config/billing.php:17 |
| `CONTENT_AUTO_PUBLISH_PILOT` | feature-flag | `false` | config/features.php:509 |
| `CONTENT_CALENDAR_AUTOPILOT` | optional | `false` | config/features.php:489 |
| `CONTENT_CALENDAR_ENABLED` | feature-flag | `false` | config/features.php:483 |
| `CONTENT_CLIP_RANK_N` | optional | `5` | config/content.php:21 |
| `CONTENT_EMAIL_ONESHOT` | optional | `false` | config/features.php:517 |
| `CONTENT_FORWARD_DRAFT_MAX_PER_RUN` | optional | `10` | config/content.php:43 |
| `CONTENT_FROM_LECTURES` | optional | `false` | config/features.php:474 |
...
| `COURSE_RECORDINGS_SALES` | optional | `false` | config/features.php:132 |
| `CRM_COCKPIT` | optional | `false` | config/features.php:78 |
| `CRM_FOLLOW_UP_TASKS` | optional | `false` | config/features.php:596 |
| `CRM_PIPELINE_BOARD` | optional | `false` | config/features.php:543 |
...
| `DB_CONNECTION` | optional | `'mysql'` | config/database.php:18<br>config/queue.php:88<br>config/queue.php:105 |
...
| `DOZHIM_DRIP` | optional | `false` | config/features.php:621 |
| `DOZHIM_QUEUE` | optional | `false` | config/features.php:607 |
...
| `EMAIL_CAMPAIGNS` | optional | `false` | config/features.php:429 |
...
| `GAMES_SKILL_DRILLS` | optional | `false` | config/features.php:644 |
| `GOOGLE_CLIENT_ID` | required | `—` | config/services.php:349 |
| `GOOGLE_CLIENT_SECRET` | secret | `—` | config/services.php:350 |
| `GOOGLE_REDIRECT_URI` | optional | `'/auth/google/callback'` | config/services.php:351 |
...
| `HOMEWORK_AUTO_OPEN_ALIGN_HOUR` | optional | `9` | config/homework.php:112 |
| `HOMEWORK_AUTO_OPEN_CHANNELS` | optional | `'telegram,vk'` | config/homework.php:118 |
| `HOMEWORK_AUTO_OPEN_CLOSE_PREVIOUS` | optional | `false` | config/homework.php:123 |
| `HOMEWORK_AUTO_OPEN_COURSES` | optional | `''` | config/homework.php:96 |
| `HOMEWORK_AUTO_OPEN_DELAY_HOURS` | optional | `12` | config/homework.php:109 |
| `HOMEWORK_AUTO_OPEN_ENABLED` | feature-flag | `true` | config/homework.php:91 |
| `HOMEWORK_AUTO_OPEN_GENERIC_COURSES` | optional | `''` | config/homework.php:150 |
| `HOMEWORK_AUTO_OPEN_GENERIC_IMMEDIATE` | optional | `true` | config/homework.php:159 |
| `HOMEWORK_AUTO_OPEN_GENERIC_PROMPT` | optional | `'Домашнее задание',` | config/homework.php:153 |
| `HOMEWORK_AUTO_OPEN_LESSONS` | optional | `'1,2,3,4,5'` | config/homework.php:104 |
| `HOMEWORK_MAX_FILES` | optional | `10` | config/homework.php:23 |
| `HOMEWORK_MAX_FILE_KB` | optional | `30720` | config/homework.php:27 |
| `HOMEWORK_REVIEWERS_ENABLED` | feature-flag | `true` | config/homework.php:56 |
| `HOMEWORK_REVIEWER_CHANNELS` | optional | `'database,mail,telegram'` | config/homework.php:62 |
| `HOMEWORK_REVIEWER_DIGEST_DAY` | optional | `1` | config/homework.php:70 |
| `HOMEWORK_REVIEWER_DIGEST_ENABLED` | feature-flag | `true` | config/homework.php:67 |
| `HOMEWORK_REVIEWER_DIGEST_TIME` | optional | `'09:00'` | config/homework.php:71 |
| `HOMEWORK_TG_TAG_ENABLED` | feature-flag | `true` | config/homework.php:178 |
| `HOMEWORK_TG_TAG_LOOKBACK_HOURS` | optional | `72` | config/homework.php:181 |
| `HOMEWORK_TG_TAG_PENDING_TTL` | optional | `60` | config/homework.php:187 |
| `HOMEWORK_TG_TAG_POST_OPEN_INVITE` | optional | `true` | config/homework.php:184 |
| `HOMEWORK_TOTAL_MAX_KB` | optional | `92160` | config/homework.php:32 |
...
| `HUB_TRANSLITERATE` | optional | `false` | config/features.php:176 |
...
| `KINESCOPE_PILOT` | feature-flag | `false` | config/features.php:450 |
| `KINESCOPE_PILOT_COURSE_ID` | required | `—` | config/video.php:16 |
| `KOCHERGINA_SOURCE_PATH` | optional | `base_path('../SanskritGrammar/KocherginaUchebnik_1998/Kochergina_un…` | config/homework.php:128 |
| `KOSHA_READER` | optional | `false` | config/features.php:167 |
| `KOSHA_SRS` | optional | `false` | config/features.php:156 |
...
| `LEAD_CONVERTED_AT_ON_COURSE_PAID` | optional | `false` | config/features.php:634 |
...
| `LECTURE_BUILDER_URL` | optional | `'http://127.0.0.1:5001'` | config/services.php:322 |
...
| `MANAGER_SALES_REPORT` | optional | `false` | config/features.php:727 |
...
| `MARKETING_SEGMENTS` | optional | `false` | config/features.php:529 |
...
| `MONEY_GRANT_REQUIRE_GROUPS` | optional | `false` | config/features.php:377 |
...
| `NEWSLETTER_SUBSCRIBE_ENABLED` | feature-flag | `true` | config/features.php:205 |
...
| `PAYPAL_API_BASE_URL` | required | `—` | config/services.php:384 |
| `PAYPAL_API_MODE` | optional | `'sandbox'` | config/services.php:378 |
| `PAYPAL_CLAIM_ENABLED` | feature-flag | `false` | config/services.php:370 |
| `PAYPAL_CLIENT_ID` | required | `—` | config/services.php:379 |
| `PAYPAL_CLIENT_SECRET` | secret | `—` | config/services.php:380 |
| `PAYPAL_ME_LINK` | required | `—` | config/services.php:371 |
| `PAYPAL_RECIPIENT` | required | `—` | config/services.php:372 |
| `PAYPAL_SKIP_WEBHOOK_SIGNATURE` | optional | `false` | config/services.php:383 |
| `PAYPAL_SUBSCRIPTIONS_ENABLED` | feature-flag | `false` | config/features.php:691<br>config/services.php:377 |
| `PAYPAL_WEBHOOK_ID` | required | `—` | config/services.php:381 |
...
| `QUEUE_FAILED_DRIVER` | optional | `'database-uuids'` | config/queue.php:104 |
...
| `RQ4_STUDY` | optional | `false` | config/features.php:189 |
...
| `SLOVAR_ENRICHMENT` | optional | `false` | config/features.php:145 |
...
| `SOFT_ALERT_WEBHOOK_SECRET` | secret | `''` | config/cabinet_probe.php:109 |
| `SOFT_ALERT_WEBHOOK_TIMEOUT` | optional | `8` | config/cabinet_probe.php:110 |
| `SOFT_ALERT_WEBHOOK_URL` | optional | `''` | config/cabinet_probe.php:108 |
...
| `STAFF_IMPERSONATION` | optional | `false` | config/features.php:682 |
| `START_CHTENIYA_COHORT_ENABLED` | feature-flag | `false` | config/features.php:709 |
...
| `SUPPORT_LEAD_CAPTURE` | optional | `false` | config/features.php:266 |
| `SUPPORT_OBSERVABILITY` | optional | `false` | config/features.php:223 |
...
| `SUPPORT_VISITOR_GEO` | optional | `false` | config/features.php:121 |
| `SUPPORT_VISITOR_PRESENCE` | optional | `false` | config/features.php:253 |
| `SUPPORT_WEB_ROLLUPS` | optional | `false` | config/features.php:238 |
...
| `TELEGRAM_HARVEST_ACCOUNT_NAME` | optional | `'harvester'` | config/services.php:172 |
| `TELEGRAM_HARVEST_CORPUS_SILENCE_AFTER_HOURS` | optional | `48` | config/services.php:193 |
| `TELEGRAM_HARVEST_ENABLED` | feature-flag | `false` | config/services.php:170 |
| `TELEGRAM_HARVEST_HISTORY_LIMIT` | optional | `200` | config/services.php:173 |
| `TELEGRAM_HARVEST_MEDIA_DOWNLOAD_PEERS` | optional | `''` | config/services.php:208 |
| `TELEGRAM_HARVEST_PEERS` | optional | `''` | config/services.php:175 |
| `TELEGRAM_HARVEST_PEERS_FILE` | required | `—` | config/services.php:177 |
| `TELEGRAM_HARVEST_PEER_DELAY_MAX` | optional | `0` | config/services.php:203 |
| `TELEGRAM_HARVEST_PEER_DELAY_MIN` | optional | `0` | config/services.php:202 |
| `TELEGRAM_HARVEST_ROSTER_STALE_AFTER_HOURS` | optional | `6` | config/services.php:188 |
| `TELEGRAM_HARVEST_ROSTER_TIMEOUT_SECONDS` | optional | `600` | config/services.php:199 |
| `TELEGRAM_HARVEST_STORE_PATH` | required | `—` | config/services.php:183 |
...
| `TELEGRAM_ZAPISI_BOT_ENABLED` | feature-flag | `false` | config/features.php:388 |
...
| `TELEGRAM_ZAPISI_POLL_TIMEOUT_SECONDS` | optional | `50` | config/services.php:248 |
| `TEST_MANAGER_EMAIL` | optional | `'smoke-manager@samskrte.ru'` | config/services.php:308 |
| `TEST_MANAGER_NAME` | optional | `'Smoke Manager'` | config/services.php:310 |
| `TEST_MANAGER_PASSWORD` | secret | `—` | config/services.php:309 |
| `TEST_STUDENT_EMAIL` | optional | `'smoke-student@samskrte.ru'` | config/services.php:316 |
| `TEST_STUDENT_NAME` | optional | `'Smoke Student'` | config/services.php:318 |
| `TEST_STUDENT_PASSWORD` | secret | `—` | config/services.php:317 |
| `TOCHKA_API_TOKEN` | secret | `—` | config/services.php:43 |
| `TOCHKA_API_URL` | required | `—` | config/services.php:42 |
| `TOCHKA_AUTHORIZED_NOT_PAID` | optional | `false` | config/features.php:367 |
| `TOCHKA_CUSTOMER_CODE` | required | `—` | config/services.php:44 |
| `TOCHKA_MERCHANT_ID` | required | `—` | config/services.php:48 |
| `TOCHKA_RECURRING_ENABLED` | feature-flag | `false` | config/features.php:654 |
| `TOCHKA_RECURRING_MODES` | optional | `'per_course,club,installment'` | config/features.php:662 |
| `TOCHKA_TAX_SYSTEM_CODE` | required | `—` | config/services.php:51 |
| `TOCHKA_VAT_TYPE` | optional | `'none'` | config/services.php:52 |
| `TOCHKA_WEBHOOK_GUARD` | optional | `true` | config/features.php:356 |
...
| `UPGRADE_CREDIT_REFUND_LINK` | optional | `false` | config/features.php:557 |
| `VIDEO_RESUME` | optional | `false` | config/features.php:441 |
...
| `VK_CLIENT_ID` | required | `—` | config/services.php:354 |
| `VK_CLIENT_SECRET` | secret | `—` | config/services.php:355 |
| `VK_CONFIRM_CODE` | required | `—` | config/services.php:260 |
| `VK_GROUP_ID` | required | `—` | config/services.php:259 |
| `VK_ORS_DATA_PATH` | optional | `storage_path('app/vk_ors')` | config/content.php:14 |
| `VK_REDIRECT_URI` | optional | `'/auth/vkontakte/callback'` | config/services.php:356 |
| `YANDEX_AGENT_ID` | required | `—` | config/services.php:269 |
| `YANDEX_API_KEY` | secret | `—` | config/services.php:267 |
| `YANDEX_CLIENT_ID` | required | `—` | config/services.php:359 |
| `YANDEX_CLIENT_SECRET` | secret | `—` | config/services.php:360 |
...
| `YANDEX_FOLDER_ID` | required | `—` | config/services.php:268 |
| `YANDEX_REDIRECT_URI` | optional | `'/auth/yandex/callback'` | config/services.php:361 |
| `ZOOM_ACCOUNT_ID` | required | `—` | config/services.php:334 |
| `ZOOM_AUTO_CREATE` | optional | `false` | config/features.php:574 |
...
| `ZOOM_WEBHOOK_SECRET` | secret | `—` | config/services.php:341 |
