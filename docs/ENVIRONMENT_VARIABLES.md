...
| `HOMEWORK_AUTO_OPEN_ALIGN_HOUR` | optional | `9` | config/homework.php:225 |
| `HOMEWORK_AUTO_OPEN_CHANNELS` | optional | `'telegram,vk'` | config/homework.php:231 |
| `HOMEWORK_AUTO_OPEN_CLOSE_PREVIOUS` | optional | `false` | config/homework.php:236 |
| `HOMEWORK_AUTO_OPEN_COURSES` | optional | `''` | config/homework.php:183 |
| `HOMEWORK_AUTO_OPEN_DELAY_HOURS` | optional | `12` | config/homework.php:222 |
| `HOMEWORK_AUTO_OPEN_ENABLED` | feature-flag | `true` | config/homework.php:149 |
| `HOMEWORK_AUTO_OPEN_EXCLUDE_COURSES` | optional | `''` | config/homework.php:168 |
| `HOMEWORK_AUTO_OPEN_EXCLUDE_PREFIXES` | optional | `'ctenie-'` | config/homework.php:177 |
| `HOMEWORK_AUTO_OPEN_GENERIC_COURSES` | optional | `''` | config/homework.php:263 |
| `HOMEWORK_AUTO_OPEN_GENERIC_IMMEDIATE` | optional | `true` | config/homework.php:272 |
| `HOMEWORK_AUTO_OPEN_GENERIC_PROMPT` | optional | `'Домашнее задание',` | config/homework.php:266 |
| `HOMEWORK_AUTO_OPEN_KOCHERGINA_MAX` | optional | `5` | config/homework.php:195 |
| `HOMEWORK_AUTO_OPEN_KOCHERGINA_PREFIX` | optional | `'grammatika-po-kocerginoi-'` | config/homework.php:189 |
| `HOMEWORK_AUTO_OPEN_LESSONS` | optional | `'1,2,3,4,5'` | config/homework.php:217 |
| `HOMEWORK_AUTO_OPEN_MIN_COURSE_START` | optional | `'2026-06-01'` | config/homework.php:158 |
| `HOMEWORK_AUTO_OPEN_MISSING_MAPPING_ALERT` | optional | `true` | config/homework.php:210 |
| `HOMEWORK_AUTO_OPEN_POLICY_EPOCH` | optional | `'2026-08-18'` | config/homework.php:163 |
| `HOMEWORK_AUTO_OPEN_SCOPE` | optional | `'all'` | config/homework.php:154 |
| `HOMEWORK_AUTO_OPEN_WITHOUT_TEXTBOOK_LESSON` | optional | `true` | config/homework.php:206 |
...
| `HOMEWORK_TG_TAG_ENABLED` | feature-flag | `true` | config/homework.php:291 |
| `HOMEWORK_TG_TAG_LOOKBACK_HOURS` | optional | `72` | config/homework.php:294 |
| `HOMEWORK_TG_TAG_PENDING_TTL` | optional | `60` | config/homework.php:300 |
| `HOMEWORK_TG_TAG_POST_OPEN_INVITE` | optional | `true` | config/homework.php:297 |
| `HOMEWORK_TOTAL_MAX_KB` | optional | `92160` | config/homework.php:47 |
| `HOMEWORK_UNREVIEWED_OPEN_ALERT` | optional | `true` | config/homework.php:119 |
| `HOMEWORK_UNREVIEWED_PREFIXES` | optional | `'napevnyi-sanskrit-,prodlenka-'` | config/homework.php:110 |
...
| `KOCHERGINA_SOURCE_PATH` | optional | `base_path('../SanskritGrammar/KocherginaUchebnik_1998/Kochergina_un…` | config/homework.php:241 |
