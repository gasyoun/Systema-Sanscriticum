...
| `CATALOG_NEXT_STEP` | optional | `false` | config/features.php:975 |
...
| `CLUB_COURSE_SLUG` | optional | `'club'` | config/membership.php:57 |
| `CLUB_DEFAULT_TERM_MONTHS` | optional | `1` | config/membership.php:72 |
| `CLUB_GRACE_DAYS` | optional | `3` | config/membership.php:65 |
| `CLUB_MAX_TERM_MONTHS` | optional | `12` | config/membership.php:78 |
...
| `FLAGSHIP_CTA_AB` | optional | `false` | config/features.php:983 |
| `FLAGSHIP_EXPERIMENT_STARTED_AT` | optional | `''` | config/flagship_experiments.php:28 |
| `FREE_TIER_COHORT_FILE` | optional | `'membership/free_tier_cohort.txt'` | config/membership.php:137 |
| `FREE_TIER_DAEMON_APPLY` | optional | `false` | config/membership.php:115 |
| `FREE_TIER_GRANT_DAYS` | optional | `30` | config/membership.php:85 |
| `FREE_TIER_GRANT_REASON` | optional | `'free_tier_monthly'` | config/membership.php:93 |
...
| `GRAMMAR_LAB` | optional | `false` | config/features.php:897 |
...
| `GRAMMAR_LAB_PILOT` | feature-flag | `false` | config/features.php:911 |
...
| `GRAMMAR_LAB_SEMANTIC` | optional | `false` | config/features.php:904 |
...
| `HINDI_ATTACHMENT_DRILLS` | optional | `false` | config/features.php:937 |
| `HINDI_MY_SRS_DECK` | optional | `false` | config/features.php:946 |
...
| `HINDI_PROGRAMME_PLAYLIST` | optional | `false` | config/features.php:920 |
| `HINDI_TG_CURATED_PRACTICE` | optional | `false` | config/features.php:955 |
| `HINDI_TRANSCRIPT_DRILLS` | optional | `false` | config/features.php:928 |
...
| `SUPPORT_CAPACITY_ROUTING` | optional | `false` | config/features.php:967 |
| `SUPPORT_DEPARTMENTS` | optional | `false` | config/features.php:966 |
...
| `TELEPHONY_CALLBACK_REQUEST` | optional | `false` | config/features.php:963 |
| `TELEPHONY_PSTN` | optional | `false` | config/features.php:964 |
| `TELEPHONY_RECORDING` | optional | `false` | config/features.php:965 |
