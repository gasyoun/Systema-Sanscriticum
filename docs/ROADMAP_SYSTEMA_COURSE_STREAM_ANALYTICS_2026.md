...
**Волна 3 закрыта.** Единственный остаток — 72 несопоставленные подписи в Zoom по курсу 332 (устройства, телефоны, неоднозначные), которые связывает куратор вручную по сценарию из [руководства куратора](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/docs/CURATOR_ADMIN_GUIDE_RU.md).
