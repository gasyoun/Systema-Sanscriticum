...
20 занятий 17-09-2025…18-03-2026 и вставлено 529 строк посещаемости; повторный прогон
даёт 0/0 (идемпотентность проверена на боевых данных). Плашка покрытия по семье
332/375/424: **было 17 из 70 (23,9 %), стало 30 из 70 (42,9 %)**, узнано по вебинарам
**было 0, стало 19**. У курса 375 досбирать было нечего — 0 строк к вставке, что и
предсказывал диагноз. Ни одна существующая строка не изменена и не удалена.
