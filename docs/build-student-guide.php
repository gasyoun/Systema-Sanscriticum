...
/*
 * Сборка PDF гида студента из ЕДИНСТВЕННОГО источника —
 * docs/STUDENT_CABINET_GUIDE_RU.md (H3212, волна 1).
 *
 * Учительский сборщик docs/build-teacher-guide.php не трогаем.
 */
...
$source = __DIR__.'/STUDENT_CABINET_GUIDE_RU.md';
...
$canvas->page_text(
    40, 812,
    'актуально в кабинете: /dvaram/help',
    $font, 8, [0.6, 0.6, 0.6]
);
