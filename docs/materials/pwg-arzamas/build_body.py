#!/usr/bin/env python3
"""Render docs/materials/pwg-arzamas/SOURCE.md -> body.html (import payload).
...
def main() -> None:
    ...
    if h2_count < 15:
        raise SystemExit(f"ACCEPT A1 FAIL: only {h2_count} h2 (need >=15)")
    expected = meta.get("expected_min_h2", 15)
