...
| `MAIL_FROM_*` на проде | `rusamskrtam@yandex.ru` / **«ORS LMS»** (исправлено на «Институт исследования санскрита Общества ревнителей санскрита» 25-08 (первая правка была неверной)) |
