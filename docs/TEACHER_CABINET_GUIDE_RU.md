...
![Раздел «Мои материалы» в панели преподавателя](screenshots/teacher-guide/my-materials.png)

Здесь вы присылаете видео-анонс курса, обложку 4:3 и конспект лекций — по одной
заявке на курс. Отправленное сюда **не публикуется само**: заявку смотрит
куратор и переносит на витрину курса только после проверки. Статус заявки
(«Не подано» / «Принято» / «В работе» / «Опубликовано») виден прямо в таблице.
Отправить заявку повторно можно в любой момент — она обновит текущую, а не
создаст вторую.
...
Справочная доска: у каждой живой группы — ссылка на страницу курса, у каждого
тарифа (блока) — готовая ссылка формы самообслуживания и фиксированная цена в
евро/долларах. Когда ученик спрашивает «сколько и куда платить» (особенно
оплачивающий из-за рубежа) — скопируйте ссылку нужного тарифа и отправьте:
форма сама покажет сумму и примет уведомление об оплате.
