...
| Financial-aid / benefit-price visibility at price surfaces | CO | **adapt** | Maps to льготные цены + installments (M5: +7…+9 pp) |
...
| Deadline mechanics, streak guilt, scarcity | CO/DU | **reject** | Violates the measured no-pressure guardrail (M5, −7…−9 pp) |
