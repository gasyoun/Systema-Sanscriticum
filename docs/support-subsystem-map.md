...
_Created: 01-07-2026 · Last updated: 14-08-2026_
...
| Telephony / callback / departments / capacity routing | 6+ | **H2486 (14-08-2026) HOLD.** Packet: [PACKET_JIVO_TELEPHONY_PROVIDER_ROUTING_GATE_2026.md](https://github.com/gasyoun/Systema-Sanscriticum/blob/main/docs/PACKET_JIVO_TELEPHONY_PROVIDER_ROUTING_GATE_2026.md). Adapter only (`FollowUpTask::TYPE_CALL` + `CallEvent`). No Jivo VATS, no number purchase. Flags default OFF. **H2749 (14-08-2026) Phase 2 STOP:** 0 completed call tasks vs ≥20; H2747 not live; no `CallProvider`; recording OFF (Q-law-5 / DPA absent). |
