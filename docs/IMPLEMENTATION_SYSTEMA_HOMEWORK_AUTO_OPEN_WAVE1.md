...
Правками H1790 и H1795 в самом `.docx` восстановлены точки у четырёх маркеров упражнений
(занятия 30, 5 и 7 — два), поэтому разрывов нумерации не осталось ни в одном из 35 занятий
с блоком, а маркеров без точки в книге не осталось вовсе (0 из 178). На поведение
