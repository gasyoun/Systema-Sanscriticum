...
(H1789). Отвечает на вопрос эксплуатации: у какого занятия условие ДЗ будет с текстом
упражнений, а у какого — с отсылочной формулировкой.
...
[EXERCISE_BLOCK_COVERAGE_KOCHERGINA_2026.md](https://github.com/gasyoun/SanskritGrammar/blob/main/KocherginaUchebnik_1998/EXERCISE_BLOCK_COVERAGE_KOCHERGINA_2026.md); там же разобраны две особенности
...
последнее) и пять разных форм маркера задания. Номера строк относятся к состоянию
