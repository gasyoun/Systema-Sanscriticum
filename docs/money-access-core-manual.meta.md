...
| 2 | Close C3 durably: `payments.first_paid_at` + backfill | Removes the pre-08-06-2026 audit blind spot of the resurrection guard | queued handoff (schema change, D16) |
