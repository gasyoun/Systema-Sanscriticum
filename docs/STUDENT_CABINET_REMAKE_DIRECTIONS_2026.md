...
| R28 | Mockup #5 (ruled 15-07-2026, after PR #522 merged + v1.9.0) | **Направление D «Путь»** (Journey & membership hub) — завершает набор: все 4 направления замокаплены | та же визуальная система; карта станций, «загорание» следующей станции только после полного прохождения, членство = непрерывность между станциями; [H958](https://github.com/gasyoun/Uprava/blob/main/handoffs/H958-Fable_Systema-Sanscriticum_student-cabinet-mockup5-journey-membership-hub_15.07.26.md) |
