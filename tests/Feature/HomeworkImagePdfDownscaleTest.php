 ...
 * до max_edge_px/JPEG, а неподъёмная картинка даёт заглушку, а не 500.
 */
class HomeworkImagePdfDownscaleTest extends TestCase
{
    ...
    public function large_image_is_downscaled_below_max_edge(): void
    {
        ...
        $this->assertLessThanOrEqual((int) config('homework.image_pdf.max_edge_px'), max($w, $h));
    ...
    public function submitting_large_photos_succeeds_and_builds_pdf(): void
    {
        ...
        // Сборка идёт джобой на воркере (H3095) — играем воркера руками.
