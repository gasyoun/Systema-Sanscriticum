...
class SupportDmShadowModeTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        config([
            ...
            // H3766 B5 добавил покатегорийные пороги, выведенные на ЖИВОМ
            // корпусе (A 18.1, B 14.8, C 19.4, F 15.7). Здесь корпус игрушечный,
            // и его скоры до этих чисел не дотягивают — а этот набор проверяет
            // ворота, а не калибровку. Пороги обнуляем, их значения пинятся
            // отдельно в ShadowScoreFloorTest.
