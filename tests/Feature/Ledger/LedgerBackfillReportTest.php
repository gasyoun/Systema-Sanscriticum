...
class LedgerBackfillReportTest extends TestCase
{
    ...
    public function test_shadow_mode_posts_through_triggers_and_rolls_everything_back(): void
    {
        ...
        // Распределено ядром: план 12500 ₽ минус возврат 3000 ₽, снятый LIFO с
        // блоков полностью распределённой оплаты (свободного остатка у неё нет).
        $this->assertSame(1_250_000 - 300_000, $s['ledger_allocated_kopecks']);
        $this->assertLessThanOrEqual($s['ledger_net_kopecks'], $s['ledger_allocated_kopecks']);
    }
