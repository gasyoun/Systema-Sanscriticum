 ...
 *
 * H3999 (шаг I1a/I1b) вводил draft_only-отказ на tap-дорожке; H4440 (MG
 * 09-09-2026) снял его явным рулингом — кнопка теперь под КАЖДЫМ черновиком,
 * включая деньги/доступ/сертификат. Отправитель РЕШАЕТ нажатием; админ-очередь
 * осталась как место правки текста, не как обязательный маршрут.
 *
...
final class SupportHintSendButton
{
    ...
    public function handle(array $callback): void
    {
        ...
        // кнопка для всех трёх классов — деньги/доступ/сертификат). Прежний отказ
        // draft_only на tap-дорожке (H3999 A1) снят явным рулингом: цены почти
        // везде универсальные, перепроверять каждое высказывание в админке не нужно.
        // Резолвер по-прежнему МЕТИТ draft_only в facts/send_policy — маркер
        // остаётся в аудите, решает человек нажатием.
