 ...
 * Кассовый чек формирует платежная система — письмо на него ссылается,
 * но не воспроизводит.
 */
class PurchaseConfirmationMail extends Mailable implements ShouldQueue
{
     ...
     * Null — когда объем из платежа не восстановить (ручной платеж без тарифа):
     * строка тарифа в письме просто не выводится, чек не врет.
     */
