...
/**
 * Хай-вотер-марка support:suggest-answers на источник, чтобы не пересканировать
 * всю историю ChatMessage/TelegramSupportMessage на каждый 15-минутный прогон.
 * Точная копия механики ReminderDetectionCursor (H187).
 */
class SupportAnswerDetectionCursor extends Model
{
    protected $fillable = [
        'source_type',
        'last_source_id',
