...
class MarketingSetting extends Model
{
    ...
    protected $fillable = [
        ...
        'homework_notify_opened',
        'homework_notify_deadline_near',
        'homework_notify_submitted',
        'homework_notify_returned',
        'homework_notify_accepted',
        'homework_notify_locked',
        'homework_telegram_chat_id',
        'homework_vk_peer_id',
    ...
    protected $casts = [
        ...
        'homework_notify_opened' => 'boolean',
        'homework_notify_deadline_near' => 'boolean',
        'homework_notify_submitted' => 'boolean',
        'homework_notify_returned' => 'boolean',
        'homework_notify_accepted' => 'boolean',
        'homework_notify_locked' => 'boolean',
