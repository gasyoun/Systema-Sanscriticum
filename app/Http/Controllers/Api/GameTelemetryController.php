 ...
 * `user_id` (H1680) ставится только когда сессия уже аутентифицирована —
 * не расширяет что клиент может внести, только что сервер уже знает о себе.
 *
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            GameEvent::create([
                ...
                // H1680: только на СВОЕЙ новой записи, когда сессия уже
                // аутентифицирована — сервер источник правды, клиент этого
                // не подделает. Бэкафилл прежних anon_id-строк делает
                // GamesOnboardingImporter при первом логине, не здесь.
