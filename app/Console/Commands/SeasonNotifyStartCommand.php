...
class SeasonNotifyStartCommand extends Command
{
    ...
    private function telegramText(?Season $season): string
    {
        ...
        return implode("\n", [
            ...
            '',
            'За решенные раунды начисляется прана и растет ранг:',
            'Śiṣya → Adhyāyin → Snātaka → Ācārya → Paṇḍita.',
            '',
            'Лидерборд сезона — от базового снапшота: у всех равный отсчет, а подарки праны между студентами позицию не меняют.',
            '',
