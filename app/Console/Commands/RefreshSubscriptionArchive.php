 ...
 *
 * Завершенный поток (format=recorded) попадает в архив подписки только
 ...
 * завершения) — попадает в отчет как ручной остаток. Уже включенные
    ...
    public function handle(): int
    {
        ...
        foreach ($candidates as $course) {
            ...
            if ($last === null) {
                ...
                // format=recorded сам является маркером «поток завершен, записи
