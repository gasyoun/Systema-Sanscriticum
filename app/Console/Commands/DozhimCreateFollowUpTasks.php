 ...
 * FollowUpTask на каждую недожатую open Deal, у которой еще нет открытой
 ...
 * пока флаг OFF, бакет пуст и команда не создает ни одной задачи. Видимость
 ...
 * даже если крыло кокпита их еще не показывает.
 */
