...
/**
 * Import the PWG Arzamas-style longread («Петербургский словарь») into the
 * articles table from the repo-controlled pack under docs/materials/pwg-arzamas/.
 *
 * Source of truth is the pack (H1620 / PLAN_SYSTEMA_PWG_ARZAMAS_MATERIAL_2026.md,
 * decision D11): SOURCE.md is rendered to body.html by build_body.py; this
 * command only upserts the already-rendered payload — it never accepts remote
 * or user-supplied HTML (ARCHITECTURE §5).
 *
 ...
 */
class ImportPwgArzamasMaterial extends Command
{
    protected $signature = 'materials:import-pwg-arzamas
