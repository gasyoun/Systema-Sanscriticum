 ...
 * 112 человек по CRM; 88 в активной базе). Зачета прошлых покупок нет —
 ...
 * paid на курсах «в записи») и ПЕЧАТАЕТ счетчик для сверки — расхождение
 * с 112 ожидаемо и фиксируется в build-отчете.
 *
