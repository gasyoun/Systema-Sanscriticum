...
/**
 * Докатка незавершенных групп split-upload на off-site диск: обрыв связи
...
class ResumeYandexParts extends Command
{
    ...
    protected $description = 'Докатить незавершенные группы split-upload частей на off-site диск';
