...
/**
 * Отчет о пустых курсах и группах-оболочках (H3122).
 *
 ...
 * Удаление, когда до него дойдет дело, будет отдельной командой, читающей этот
 * же вердикт.
 */
class AuditCatalogShells extends Command
{
    ...
    protected $description = 'Найти пустые курсы и группы-оболочки (кандидаты на удаление). Только отчет, ничего не удаляет.';
