 ...
 * шлет финдиру/бухгалтеру сводку всех фаз с пометкой цвета, включая пульс
 * «активные платные ученики» строками. Это «ритм обзора» с зубами: панель
 * бесполезна, если в нее не заглядывают (урок антикейса «Лингвистик» — финплан
 * без внедрения и ритма).
 *
 * По умолчанию шлет всегда (дайджест — часть ритма); с --only-alerts шлет
