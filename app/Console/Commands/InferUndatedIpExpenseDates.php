 ...
 * «предположительный расчет», «пока предварительно») в книге писались
 ...
 *
 * Ничего не выдумывается сверх вкладки: день внутри месяца остается
 * неизвестен — берется граница месяца по данным той же вкладки. Каждая
...
class InferUndatedIpExpenseDates extends Command
{
    protected $signature = 'ip-expenses:infer-undated-dates
        {--apply : Записать выведенные даты; без флага — только отчет}';
