 ...
 * «сдано / проверено / еще ждет». Курсы без проверяющих сюда не попадают вовсе
 * и продолжают получать письмо на каждую работу, как раньше.
 *
 * Пустую сводку не шлем: тишина за неделю — это тоже сигнал, но не повод писать.
 */
