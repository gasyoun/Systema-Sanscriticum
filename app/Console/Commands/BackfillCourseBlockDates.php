 ...
 *      на курсе 332 все 15 уроков четырех блоков стоят на 2025-10-08. Записать
 *      ее значило бы выдать артефакт импорта за расписание — а «блок получил
 *      дату наугад» прямо запрещено приемкой H3084.
 *
 * Оба случая печатаются поименно, а не молча пропускаются: пустой блок с
