 ...
 * в ЛС не меньше двух раз и все еще не связан с кабинетом.
 *
 * Зачем отдельно от {@see SupportSendLinkInvites}: та команда ОТПРАВЛЯЕТ
 * приглашения и живет под cooldown'ом; эта ничего не отправляет студентам и
 ...
 * ответило бы одному студенту остатком другого. Привязка остается ручной.
 */
