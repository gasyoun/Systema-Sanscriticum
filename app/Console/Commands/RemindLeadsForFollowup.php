 ...
 * менеджеру о его заявках, по которым наступил (или прошел) намеченный срок
 * контакта и которые еще в работе. Пинг уходит менеджеру в Telegram одним
 * списком; reminded_at не дает слать повторно в тот же день.
 *
...
class RemindLeadsForFollowup extends Command
{
    ...
    /** Статусы, по которым лид еще «живой» и требует контакта. */
