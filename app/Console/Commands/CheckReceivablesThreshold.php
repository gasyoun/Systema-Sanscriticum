 ...
 * «максимально допустимой дебиторки», растет доля неликвида или пробит лимит
 * рассрочки), шлет финдиру/бухгалтеру заметное уведомление в админку.
 *
 * Это и есть замена ручного мониторинга владельца: он не смотрит цифры каждый
 * день — система сама зовет, когда дебиторка выходит из-под контроля.
 */
