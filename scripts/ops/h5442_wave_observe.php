...
/*
 ...
 |
 | Env H5442_SINCE (app-local time, Europe/Moscow) overrides the default enable
 | time 2026-09-24 16:22:51 (= 13:22:51 UTC). Writes nothing: every query is a
...
$since = Carbon::parse(getenv('H5442_SINCE') ?: '2026-09-24 16:22:51');
$now = now();
