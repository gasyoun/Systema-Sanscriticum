...
| 12 | **3-дневный диагностический марафон — Phase 1: лендинг + захват** (H440, PR TBD) | входит в общий `php artisan migrate` (№1); **дополнительно вручную**: создать через Filament-админку `LandingPage` со слагом из `MARATHON_LANDING_SLUG` (дефолт `konsultaciya-po-onlayn-kursam`) — без этой строки `/online/konsultaciya` рендерится (не 500), но без брендинга лендинга; страница уже рабочая и без неё. Первый запуск когорты — 28-08-2026, деплоить можно заранее | миграция + ручной шаг (контент) | вход воронки «Консультация по онлайн-курсам ОРС» (H440 Phase 1); **Phases 2–6 (дрип-движок, платный трек ₽500, живая консультация, тёплый хвост) — отдельные будущие PR, ещё не влиты** |
